...
**현재 버전:** v1.1.0 · **최종 콘텐츠 검토:** 2026-08-24 · **최종 기능 업데이트:** 2026-08-24 · [업데이트 기록](UPDATES.md)
...
- AI·LLM 14개 핵심 분야를 포함한 총 1,624개 검토 완료 백과 문서 제공
- 문서 간 관련 개념과 선후 학습 관계를 연결한 위키형 탐색
- 학습 목적과 난이도에 따라 문서를 순서대로 안내하는 24개 추천 코스
- 띄어쓰기·초성·약어·별칭을 지원하고 분야·코스·작성 예시로 좁히는 통합 검색
- 55개 통제 태그로 정리한 1,500개 프롬프트와 120개 코드·설정 자료 검색
- 학습 경로, 분류 평가 지표, 모델·KV 캐시 메모리와 프롬프트·JSON Schema를 다루는 4개 AI 실험실
