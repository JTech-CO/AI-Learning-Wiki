...
await writeFile('content-model/evidence/w14-production-queue.json', `${JSON.stringify(queue, null, 2)}\n`, 'utf8');
console.log(`W14 production queue: ${queue.totals.published} published, ${queue.totals.candidates} candidates, ${queue.totals.researchQueued} research queued`);
