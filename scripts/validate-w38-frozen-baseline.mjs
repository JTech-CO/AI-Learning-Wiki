...
import { W38_VERSION } from './w38-independence-lib.mjs';

const stored = JSON.parse(await readFile('content-model/quality/w38-independence-audit.json', 'utf8'));
...
console.log('W38 frozen baseline: pre-cutover legacy dependency and expansion gaps remain internally consistent');
