...
const [w4Ledger, w5Ledger, w6Ledger, w7Ledger, w8Ledger, w9Ledger, w10Ledger, w11Ledger] = await Promise.all([
...
const publicationReady = new Set([...w4Ledger.articles, ...w5Ledger.articles, ...w6Ledger.articles, ...w7Ledger.articles, ...w8Ledger.articles, ...w9Ledger.articles, ...w10Ledger.articles, ...w11Ledger.articles].filter((article) => article.publicationReady).map((article) => article.articleId));
