...
import { topicPrimarySources } from './w14-extra-sources.mjs';

export const REVIEWED_AT = '2026-07-14';
export const VERSION = 'W14-2026-07-14';
...
export function selectW14Targets(queue) {
...
export function sourcesForW14(topic, research, wikimedia, registry) {
...
export function createW14Article(topic, sources) {
...
export function familyForW14(source) {
