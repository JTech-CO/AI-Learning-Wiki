...
await writeFile('content-model/evidence/w9-production-queue.json', `${JSON.stringify(queue, null, 2)}\n`, 'utf8');
console.log(`W9 production queue: ${queue.totals.published} published, ${queue.totals.candidates} candidates, ${queue.totals.sourceRemediation + queue.totals.claimReviewQueued} existing queued`);
