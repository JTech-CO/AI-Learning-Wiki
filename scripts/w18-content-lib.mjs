...
import { topicPrimarySources } from './w18-extra-sources.mjs';

export const REVIEWED_AT = '2026-07-15';
export const VERSION = 'W18-2026-07-15';
...
export function selectW18Targets(queue) {
...
export function sourcesForW18(topic, research, wikimedia, registry) {
...
function buildBodies(topic) {
  ...
  if (!fact || !domain) throw new Error(`${topic.id}: W18 fact profile or category context missing`);
...
export function createW18Article(topic, sources) {
...
export function familyForW18(source) {
