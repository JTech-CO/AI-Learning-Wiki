...
import { topicPrimarySources } from './w15-extra-sources.mjs';

export const REVIEWED_AT = '2026-07-15';
export const VERSION = 'W15-2026-07-15';
...
export function selectW15Targets(queue) {
...
export function sourcesForW15(topic, research, wikimedia, registry) {
...
function buildBodies(topic) {
  ...
  if (!fact || !domain) throw new Error(`${topic.id}: W15 fact profile or category context missing`);
...
export function createW15Article(topic, sources) {
...
export function familyForW15(source) {
