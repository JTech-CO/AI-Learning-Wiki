...
import { topicPrimarySources } from './w16-extra-sources.mjs';

export const REVIEWED_AT = '2026-07-15';
export const VERSION = 'W16-2026-07-15';
...
export function selectW16Targets(queue) {
...
export function sourcesForW16(topic, research, wikimedia, registry) {
...
function buildBodies(topic) {
  ...
  if (!fact || !domain) throw new Error(`${topic.id}: W16 fact profile or category context missing`);
...
export function createW16Article(topic, sources) {
...
export function familyForW16(source) {
