...
import { topicPrimarySources } from './w13-extra-sources.mjs';

export const REVIEWED_AT = '2026-07-14';
export const VERSION = 'W13-2026-07-14';
...
export function selectW13Targets(queue) {
...
export function sourcesForW13(topic, research, wikimedia, registry) {
...
function buildBodies(topic) {
  ...
  if (!fact || !domain) throw new Error(`${topic.id}: W13 fact profile or category context missing`);
...
export function createW13Article(topic, sources) {
...
export function familyForW13(source) {
