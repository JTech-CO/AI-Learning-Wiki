...
import { topicPrimarySources } from './w11-extra-sources.mjs';

export const REVIEWED_AT = '2026-07-14';
export const VERSION = 'W11-2026-07-14';
...
export function selectW11Targets(queue) {
...
export function sourcesForW11(topic, research, wikimedia, registry) {
...
function buildBodies(topic) {
  ...
  if (!fact || !domain) throw new Error(`${topic.id}: W11 fact profile or category context missing`);
...
export function createW11Article(topic, sources) {
...
export function familyForW11(source) {
