...
import { topicPrimarySources } from './w17-extra-sources.mjs';

export const REVIEWED_AT = '2026-07-15';
export const VERSION = 'W17-2026-07-15';
...
export function selectW17Targets(queue) {
...
export function sourcesForW17(topic, research, wikimedia, registry) {
...
function buildBodies(topic) {
  ...
  if (!fact || !domain) throw new Error(`${topic.id}: W17 fact profile or category context missing`);
...
export function createW17Article(topic, sources) {
...
export function familyForW17(source) {
