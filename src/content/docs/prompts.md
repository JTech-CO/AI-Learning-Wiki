...
출처: [AI 개발 환경 세팅](/courses/ai-builder/01-dev-environment/) `프롬프트` `첫실행` `html`
...
출처: [AI 개발 환경 세팅](/courses/ai-builder/01-dev-environment/) `프롬프트` `점검` `세팅`
...
출처: [AI 개발 환경 세팅](/courses/ai-builder/01-dev-environment/) `프롬프트` `디버깅`
...
출처: [AI 개발 환경 세팅](/courses/ai-builder/01-dev-environment/) `프롬프트` `용어`
...
출처: [AI 개발 환경 세팅](/courses/ai-builder/01-dev-environment/) `프롬프트` `예시`
...
출처: [말로 설명해서 작은 도구 만들기 (바이브 코딩 입문)](/courses/ai-builder/02-vibe-coding-intro/) `프롬프트` `바이브코딩` `생성`
...
출처: [말로 설명해서 작은 도구 만들기 (바이브 코딩 입문)](/courses/ai-builder/02-vibe-coding-intro/) `프롬프트` `수정` `반복`
...
출처: [말로 설명해서 작은 도구 만들기 (바이브 코딩 입문)](/courses/ai-builder/02-vibe-coding-intro/) `프롬프트` `디버그` `에러`
...
출처: [말로 설명해서 작은 도구 만들기 (바이브 코딩 입문)](/courses/ai-builder/02-vibe-coding-intro/) `프롬프트` `예시` `견적 계산기`
...
출처: [말로 설명해서 작은 도구 만들기 (바이브 코딩 입문)](/courses/ai-builder/02-vibe-coding-intro/) `프롬프트` `예시` `습관 체크리스트`
...
출처: [요구사항을 프롬프트로 명세하기](/courses/ai-builder/03-requirements-spec/) `요구사항` `명세` `화면·기능·데이터`
...
출처: [요구사항을 프롬프트로 명세하기](/courses/ai-builder/03-requirements-spec/) `명세` `되묻기` `빈틈`
...
출처: [요구사항을 프롬프트로 명세하기](/courses/ai-builder/03-requirements-spec/) `분해` `화면·기능·데이터` `표`
...
출처: [요구사항을 프롬프트로 명세하기](/courses/ai-builder/03-requirements-spec/) `데이터` `타입`
...
출처: [즉석 앱 생성 — v0·Bolt·Lovable로 말로 앱 만들기](/courses/ai-builder/04-instant-app-gen/) `프롬프트` `앱생성` `풀스택`
...
출처: [즉석 앱 생성 — v0·Bolt·Lovable로 말로 앱 만들기](/courses/ai-builder/04-instant-app-gen/) `프롬프트` `UI` `v0`
...
출처: [즉석 앱 생성 — v0·Bolt·Lovable로 말로 앱 만들기](/courses/ai-builder/04-instant-app-gen/) `프롬프트` `버그수정`
...
출처: [즉석 앱 생성 — v0·Bolt·Lovable로 말로 앱 만들기](/courses/ai-builder/04-instant-app-gen/) `프롬프트` `배포` `점검`
...
출처: [즉석 앱 생성 — v0·Bolt·Lovable로 말로 앱 만들기](/courses/ai-builder/04-instant-app-gen/) `프롬프트` `예시` `앱생성`
...
출처: [AI가 만든 코드 읽기](/courses/ai-builder/05-read-ai-code/) `프롬프트` `코드읽기` `파일구조`
...
출처: [AI가 만든 코드 읽기](/courses/ai-builder/05-read-ai-code/) `프롬프트` `코드설명` `비유`
...
출처: [AI가 만든 코드 읽기](/courses/ai-builder/05-read-ai-code/) `프롬프트` `수정위치` `디버깅`
...
출처: [AI가 만든 코드 읽기](/courses/ai-builder/05-read-ai-code/) `프롬프트` `주석`
...
출처: [에러 메시지로 디버깅하기](/courses/ai-builder/06-debug-error-message/) `프롬프트` `디버깅` `상황·기대·실제`
...
출처: [에러 메시지로 디버깅하기](/courses/ai-builder/06-debug-error-message/) `프롬프트` `에러 해석`
...
출처: [에러 메시지로 디버깅하기](/courses/ai-builder/06-debug-error-message/) `프롬프트` `반복 루프`
...
출처: [에러 메시지로 디버깅하기](/courses/ai-builder/06-debug-error-message/) `프롬프트` `디버깅`
...
출처: [앱을 조금씩 고쳐 나가기](/courses/ai-builder/07-iterative-editing/) `점진적 편집` `범위 제한`
...
출처: [앱을 조금씩 고쳐 나가기](/courses/ai-builder/07-iterative-editing/) `되돌리기` `롤백`
...
출처: [앱을 조금씩 고쳐 나가기](/courses/ai-builder/07-iterative-editing/) `단계 쪼개기` `계획`
...
출처: [앱을 조금씩 고쳐 나가기](/courses/ai-builder/07-iterative-editing/) `사전 확인` `범위 제한`
...
출처: [개발 언어 지도 — 무슨 언어가 뭐에 쓰이나](/courses/ai-builder/08-language-map/) `프롬프트` `언어 선택` `초보`
...
출처: [개발 언어 지도 — 무슨 언어가 뭐에 쓰이나](/courses/ai-builder/08-language-map/) `프롬프트` `코드 식별`
...
출처: [개발 언어 지도 — 무슨 언어가 뭐에 쓰이나](/courses/ai-builder/08-language-map/) `프롬프트` `언어 비교`
...
출처: [개발 언어 지도 — 무슨 언어가 뭐에 쓰이나](/courses/ai-builder/08-language-map/) `프롬프트` `요약표`
...
출처: [개발 언어 지도 — 무슨 언어가 뭐에 쓰이나](/courses/ai-builder/08-language-map/) `프롬프트` `Python` `라이브러리`
...
출처: [HTML로 화면 뼈대 만들기](/courses/ai-builder/09-html-structure/) `HTML` `뼈대` `생성`
...
출처: [HTML로 화면 뼈대 만들기](/courses/ai-builder/09-html-structure/) `HTML` `부분 수정` `디버깅`
...
출처: [HTML로 화면 뼈대 만들기](/courses/ai-builder/09-html-structure/) `HTML` `태그` `설명`
...
출처: [HTML로 화면 뼈대 만들기](/courses/ai-builder/09-html-structure/) `HTML` `입력창` `추가`
...
출처: [CSS로 화면 꾸미기](/courses/ai-builder/10-css-styling/) `프롬프트` `색 팔레트` `글꼴`
...
출처: [CSS로 화면 꾸미기](/courses/ai-builder/10-css-styling/) `프롬프트` `코드 리뷰` `CSS`
...
출처: [CSS로 화면 꾸미기](/courses/ai-builder/10-css-styling/) `프롬프트` `flex` `디버깅`
...
출처: [CSS로 화면 꾸미기](/courses/ai-builder/10-css-styling/) `프롬프트` `반응형` `모바일`
...
출처: [JavaScript로 동작 넣기](/courses/ai-builder/11-javascript-interaction/) `프롬프트` `디버깅` `JavaScript`
...
출처: [JavaScript로 동작 넣기](/courses/ai-builder/11-javascript-interaction/) `프롬프트` `기능추가` `JavaScript`
...
출처: [JavaScript로 동작 넣기](/courses/ai-builder/11-javascript-interaction/) `프롬프트` `개념`
...
출처: [JavaScript로 동작 넣기](/courses/ai-builder/11-javascript-interaction/) `프롬프트` `도전과제`
...
출처: [브라우저 개발자도구 쓰기](/courses/ai-builder/12-browser-devtools/) `콘솔` `에러` `디버깅`
...
출처: [브라우저 개발자도구 쓰기](/courses/ai-builder/12-browser-devtools/) `네트워크` `상태코드` `API`
...
출처: [브라우저 개발자도구 쓰기](/courses/ai-builder/12-browser-devtools/) `엘리먼트` `HTML` `CSS`
...
출처: [브라우저 개발자도구 쓰기](/courses/ai-builder/12-browser-devtools/) `개발자도구` `재현` `체크리스트`
...
출처: [LLM API 첫 호출하기](/courses/ai-builder/13-first-llm-api-call/) `프롬프트` `예시`
...
출처: [LLM API 첫 호출하기](/courses/ai-builder/13-first-llm-api-call/) `프롬프트` `에러` `디버깅`
...
출처: [LLM API 첫 호출하기](/courses/ai-builder/13-first-llm-api-call/) `프롬프트` `변환` `언어`
...
출처: [LLM API 첫 호출하기](/courses/ai-builder/13-first-llm-api-call/) `프롬프트` `JSON` `응답`
...
출처: [LLM API 첫 호출하기](/courses/ai-builder/13-first-llm-api-call/) `프롬프트` `확장` `프로젝트`
...
출처: [프롬프트를 앱 기능으로 만들기](/courses/ai-builder/14-prompt-as-feature/) `시스템 프롬프트` `분류` `JSON 출력`
...
출처: [프롬프트를 앱 기능으로 만들기](/courses/ai-builder/14-prompt-as-feature/) `시스템 프롬프트` `요약` `JSON 출력`
...
출처: [프롬프트를 앱 기능으로 만들기](/courses/ai-builder/14-prompt-as-feature/) `시스템 프롬프트` `추천` `JSON 출력`
...
출처: [프롬프트를 앱 기능으로 만들기](/courses/ai-builder/14-prompt-as-feature/) `시스템 프롬프트` `점검` `few-shot`
...
출처: [데이터베이스·SQL 기초 — 데이터를 담고 꺼내기](/courses/ai-builder/15-database-sql-basics/) `SQL` `CREATE TABLE` `표 만들기`
...
출처: [데이터베이스·SQL 기초 — 데이터를 담고 꺼내기](/courses/ai-builder/15-database-sql-basics/) `SQL` `SELECT` `WHERE`
...
출처: [데이터베이스·SQL 기초 — 데이터를 담고 꺼내기](/courses/ai-builder/15-database-sql-basics/) `SQL` `AI 활용` `프롬프트`
...
출처: [SELECT와 조건 필터](/courses/ai-builder/16-select-filter/) `SQL` `예제데이터` `CREATE TABLE`
...
출처: [SELECT와 조건 필터](/courses/ai-builder/16-select-filter/) `SQL` `자연어변환` `쿼리작성`
...
출처: [SELECT와 조건 필터](/courses/ai-builder/16-select-filter/) `SQL` `점검` `디버깅`
...
출처: [SELECT와 조건 필터](/courses/ai-builder/16-select-filter/) `SQL` `WHERE` `연습문제`
...
출처: [JOIN으로 표 연결하기](/courses/ai-builder/17-join-tables/) `JOIN` `쿼리생성` `SQL`
...
출처: [JOIN으로 표 연결하기](/courses/ai-builder/17-join-tables/) `JOIN` `INNER-LEFT` `비교`
...
출처: [JOIN으로 표 연결하기](/courses/ai-builder/17-join-tables/) `JOIN` `디버깅`
...
출처: [JOIN으로 표 연결하기](/courses/ai-builder/17-join-tables/) `JOIN` `다중테이블` `확장`
...
출처: [집계와 그룹화](/courses/ai-builder/18-aggregation-grouping/) `집계` `쿼리생성` `GROUP BY`
...
출처: [집계와 그룹화](/courses/ai-builder/18-aggregation-grouping/) `WHERE` `HAVING` `디버깅`
...
출처: [집계와 그룹화](/courses/ai-builder/18-aggregation-grouping/) `에러` `디버깅` `GROUP BY`
...
출처: [집계와 그룹화](/courses/ai-builder/18-aggregation-grouping/) `검산` `집계`
...
출처: [테이블 스키마 설계](/courses/ai-builder/19-schema-design/) `스키마` `초안` `정규화`
...
출처: [테이블 스키마 설계](/courses/ai-builder/19-schema-design/) `정규화` `점검`
...
출처: [테이블 스키마 설계](/courses/ai-builder/19-schema-design/) `DBML` `다이어그램`
...
출처: [테이블 스키마 설계](/courses/ai-builder/19-schema-design/) `SQL` `CREATE TABLE`
...
출처: [인덱스와 성능](/courses/ai-builder/20-index-performance/) `프롬프트` `EXPLAIN` `진단`
...
출처: [인덱스와 성능](/courses/ai-builder/20-index-performance/) `프롬프트` `인덱스` `설계`
...
출처: [인덱스와 성능](/courses/ai-builder/20-index-performance/) `프롬프트` `복합 인덱스` `정렬`
...
출처: [인덱스와 성능](/courses/ai-builder/20-index-performance/) `프롬프트` `인덱스` `정리`
...
출처: [초보용 백엔드·DB — Supabase로 회원·데이터 저장](/courses/ai-builder/21-supabase-backend/) `Supabase` `HTML` `복붙` `todo`
...
출처: [초보용 백엔드·DB — Supabase로 회원·데이터 저장](/courses/ai-builder/21-supabase-backend/) `Supabase` `코드수정` `기능추가`
...
출처: [초보용 백엔드·DB — Supabase로 회원·데이터 저장](/courses/ai-builder/21-supabase-backend/) `Supabase` `에러해결` `디버깅`
...
출처: [Supabase 회원가입·로그인](/courses/ai-builder/22-supabase-auth/) `Supabase` `인증` `전체코드` `로그인화면`
...
출처: [Supabase 회원가입·로그인](/courses/ai-builder/22-supabase-auth/) `Supabase` `에러해석` `디버깅`
...
출처: [Supabase 회원가입·로그인](/courses/ai-builder/22-supabase-auth/) `Supabase` `구글` `OAuth` `설정점검`
...
출처: [Supabase 회원가입·로그인](/courses/ai-builder/22-supabase-auth/) `Supabase` `세션` `보호라우트`
...
출처: [RLS로 데이터 지키기](/courses/ai-builder/23-rls-data-security/) `RLS` `정책 생성` `Supabase`
...
출처: [RLS로 데이터 지키기](/courses/ai-builder/23-rls-data-security/) `RLS` `보안 감사` `with-check`
...
출처: [RLS로 데이터 지키기](/courses/ai-builder/23-rls-data-security/) `RLS` `테스트` `set-config`
...
출처: [RLS로 데이터 지키기](/courses/ai-builder/23-rls-data-security/) `RLS` `디버깅` `auth-uid`
...
출처: [파일 업로드·저장](/courses/ai-builder/24-file-upload-storage/) `Storage` `업로드` `코드`
...
출처: [파일 업로드·저장](/courses/ai-builder/24-file-upload-storage/) `Storage` `RLS` `SQL`
...
출처: [파일 업로드·저장](/courses/ai-builder/24-file-upload-storage/) `Storage` `서명 URL` `Private`
...
출처: [파일 업로드·저장](/courses/ai-builder/24-file-upload-storage/) `Storage` `오류` `디버깅`
...
출처: [Edge Function으로 서버 로직](/courses/ai-builder/25-edge-function/) `Edge Function` `코드 생성` `Deno`
...
출처: [Edge Function으로 서버 로직](/courses/ai-builder/25-edge-function/) `보안` `키 노출` `점검`
...
출처: [Edge Function으로 서버 로직](/courses/ai-builder/25-edge-function/) `함수 호출` `프론트엔드` `invoke`
...
출처: [Edge Function으로 서버 로직](/courses/ai-builder/25-edge-function/) `디버깅` `에러` `CORS`
...
출처: [GitHub 실전 — 저장·버전·협업](/courses/ai-builder/26-github-basics/) `GitHub` `커밋` `커밋 메시지`
...
출처: [GitHub 실전 — 저장·버전·협업](/courses/ai-builder/26-github-basics/) `GitHub` `PR` `풀 리퀘스트`
...
출처: [GitHub 실전 — 저장·버전·협업](/courses/ai-builder/26-github-basics/) `GitHub` `이슈` `할 일`
...
출처: [GitHub 실전 — 저장·버전·협업](/courses/ai-builder/26-github-basics/) `GitHub` `README` `AI 글쓰기`
...
출처: [커밋으로 작업 기록하기](/courses/ai-builder/27-commit-work/) `커밋 메시지` `다듬기` `git`
...
출처: [커밋으로 작업 기록하기](/courses/ai-builder/27-commit-work/) `git status` `해석` `git`
...
출처: [커밋으로 작업 기록하기](/courses/ai-builder/27-commit-work/) `되돌리기` `복구` `git`
...
출처: [커밋으로 작업 기록하기](/courses/ai-builder/27-commit-work/) `커밋 단위` `쪼개기` `git`
...
출처: [브랜치와 Pull Request](/courses/ai-builder/28-branch-pull-request/) `Pull Request` `PR 설명` `협업`
...
출처: [브랜치와 Pull Request](/courses/ai-builder/28-branch-pull-request/) `코드 리뷰` `diff` `병합`
...
출처: [브랜치와 Pull Request](/courses/ai-builder/28-branch-pull-request/) `브랜치` `네이밍`
...
출처: [브랜치와 Pull Request](/courses/ai-builder/28-branch-pull-request/) `충돌` `merge` `문제해결`
...
출처: [충돌 해결하기](/courses/ai-builder/29-resolve-conflicts/) `merge conflict` `해석` `git`
...
출처: [충돌 해결하기](/courses/ai-builder/29-resolve-conflicts/) `merge conflict` `합치기`
...
출처: [충돌 해결하기](/courses/ai-builder/29-resolve-conflicts/) `merge conflict` `검증`
...
출처: [충돌 해결하기](/courses/ai-builder/29-resolve-conflicts/) `merge conflict` `예방` `협업`
...
출처: [배포·호스팅 관리 — Vercel·Railway로 인터넷에 올리기](/courses/ai-builder/30-deploy-hosting/) `배포` `준비` `gitignore`
...
출처: [배포·호스팅 관리 — Vercel·Railway로 인터넷에 올리기](/courses/ai-builder/30-deploy-hosting/) `배포` `에러` `로그`
...
출처: [배포·호스팅 관리 — Vercel·Railway로 인터넷에 올리기](/courses/ai-builder/30-deploy-hosting/) `환경변수` `보안` `API키`
...
출처: [배포·호스팅 관리 — Vercel·Railway로 인터넷에 올리기](/courses/ai-builder/30-deploy-hosting/) `배포` `도구선택` `무료플랜`
...
출처: [환경변수와 시크릿 관리](/courses/ai-builder/31-env-secrets/) `환경변수` `리팩터링` `보안`
...
출처: [환경변수와 시크릿 관리](/courses/ai-builder/31-env-secrets/) `환경변수` `세팅` `배포`
...
출처: [환경변수와 시크릿 관리](/courses/ai-builder/31-env-secrets/) `보안` `사고대응` `키 폐기`
...
출처: [환경변수와 시크릿 관리](/courses/ai-builder/31-env-secrets/) `환경변수` `협업` `공유`
...
출처: [도메인 연결과 HTTPS](/courses/ai-builder/32-domain-https/) `DNS` `도메인 연결` `설정`
...
출처: [도메인 연결과 HTTPS](/courses/ai-builder/32-domain-https/) `DNS` `문제 진단` `디버깅`
...
출처: [도메인 연결과 HTTPS](/courses/ai-builder/32-domain-https/) `HTTPS` `SSL` `개념 설명`
...
출처: [도메인 연결과 HTTPS](/courses/ai-builder/32-domain-https/) `체크리스트` `배포` `점검`
...
출처: [에이전트 평가·테스트](/courses/ai-builder/40-agent-evaluation-testing/) `에이전트 평가` `LLM 심사관` `채점`
...
출처: [에이전트 평가·테스트](/courses/ai-builder/40-agent-evaluation-testing/) `루브릭` `회귀 테스트` `판정기준`
...
출처: [에이전트 평가·테스트](/courses/ai-builder/40-agent-evaluation-testing/) `원인 분석` `프롬프트 수정` `도구`
...
출처: [에이전트 평가·테스트](/courses/ai-builder/40-agent-evaluation-testing/) `전후 비교` `회귀 테스트` `리포트`
...
출처: [에이전트 루프 설계](/courses/ai-builder/39-agent-loop-design/) `에이전트 루프` `DECIDE` `if-then` `중단 조건`
...
출처: [에이전트 루프 설계](/courses/ai-builder/39-agent-loop-design/) `중단 조건` `무한루프` `점검`
...
출처: [에이전트 루프 설계](/courses/ai-builder/39-agent-loop-design/) `시뮬레이션` `검증` `표`
...
출처: [에이전트 루프 설계](/courses/ai-builder/39-agent-loop-design/) `상태 다이어그램` `설명` `시각화`
...
출처: [앱 제작 프로젝트 — AI로 실제 동작하는 작은 도구 만들기](/courses/ai-builder/42-app-building-project/) `예시` `투표앱` `첫제작`
...
출처: [앱 제작 프로젝트 — AI로 실제 동작하는 작은 도구 만들기](/courses/ai-builder/42-app-building-project/) `프롬프트` `앱제작` `템플릿`
...
출처: [앱 제작 프로젝트 — AI로 실제 동작하는 작은 도구 만들기](/courses/ai-builder/42-app-building-project/) `프롬프트` `기능추가` `한도절약`
...
출처: [앱 제작 프로젝트 — AI로 실제 동작하는 작은 도구 만들기](/courses/ai-builder/42-app-building-project/) `프롬프트` `디버깅` `에러`
...
출처: [앱 제작 프로젝트 — AI로 실제 동작하는 작은 도구 만들기](/courses/ai-builder/42-app-building-project/) `프롬프트` `단순화` `CDN`
...
출처: [앱 제작 프로젝트 — AI로 실제 동작하는 작은 도구 만들기](/courses/ai-builder/42-app-building-project/) `프롬프트` `도구전환` `재시작`
...
출처: [앱 제작 프로젝트 — AI로 실제 동작하는 작은 도구 만들기](/courses/ai-builder/42-app-building-project/) `프롬프트` `코드이해` `설명`
...
출처: [앱 보안 기본기](/courses/ai-builder/34-app-security-basics/) `보안점검` `취약점` `코드리뷰`
...
출처: [앱 보안 기본기](/courses/ai-builder/34-app-security-basics/) `API키` `env` `키관리`
...
출처: [앱 보안 기본기](/courses/ai-builder/34-app-security-basics/) `입력검증` `이스케이프` `SQL인젝션`
...
출처: [앱 보안 기본기](/courses/ai-builder/34-app-security-basics/) `침투테스트` `IDOR` `인증우회`
...
출처: [A4 정점: AI로 실제 앱·에이전트 자율 제작](/courses/ai-builder/38-autonomous-app-agent-building/) `프롬프트` `앱주문` `CRM`
...
출처: [A4 정점: AI로 실제 앱·에이전트 자율 제작](/courses/ai-builder/38-autonomous-app-agent-building/) `프롬프트` `앱주문` `템플릿`
...
출처: [A4 정점: AI로 실제 앱·에이전트 자율 제작](/courses/ai-builder/38-autonomous-app-agent-building/) `프롬프트` `기능추가`
...
출처: [A4 정점: AI로 실제 앱·에이전트 자율 제작](/courses/ai-builder/38-autonomous-app-agent-building/) `프롬프트` `디버그`
...
출처: [A4 정점: AI로 실제 앱·에이전트 자율 제작](/courses/ai-builder/38-autonomous-app-agent-building/) `프롬프트` `데이터저장` `postgresql`
...
출처: [A4 정점: AI로 실제 앱·에이전트 자율 제작](/courses/ai-builder/38-autonomous-app-agent-building/) `프롬프트` `무료` `라이트빌드`
...
출처: [A4 정점: AI로 실제 앱·에이전트 자율 제작](/courses/ai-builder/38-autonomous-app-agent-building/) `프롬프트` `심화`
...
출처: [정점 캡스톤 — 실사용자 있는 산출물을 기획부터 배포까지 출시](/courses/ai-builder/44-capstone-launch/) `프롬프트` `문제정의` `아이디어`
...
출처: [정점 캡스톤 — 실사용자 있는 산출물을 기획부터 배포까지 출시](/courses/ai-builder/44-capstone-launch/) `프롬프트` `v0` `제작`
...
출처: [정점 캡스톤 — 실사용자 있는 산출물을 기획부터 배포까지 출시](/courses/ai-builder/44-capstone-launch/) `프롬프트` `피드백` `사용자테스트`
...
출처: [정점 캡스톤 — 실사용자 있는 산출물을 기획부터 배포까지 출시](/courses/ai-builder/44-capstone-launch/) `프롬프트` `포트폴리오` `회고`
...
출처: [로그 확인과 롤백](/courses/ai-builder/33-log-monitoring-rollback/) `로그` `에러` `통역` `심각도`
...
출처: [로그 확인과 롤백](/courses/ai-builder/33-log-monitoring-rollback/) `롤백` `배포` `단계별`
...
출처: [로그 확인과 롤백](/courses/ai-builder/33-log-monitoring-rollback/) `모니터링` `체크리스트`
...
출처: [로그 확인과 롤백](/courses/ai-builder/33-log-monitoring-rollback/) `장애` `진단` `원인`
...
출처: [MCP로 AI를 Notion·Drive·DB에 양방향 연결하기](/courses/ai-builder/35-mcp-tool-integration/) `MCP` `Notion` `읽기-쓰기`
...
출처: [MCP로 AI를 Notion·Drive·DB에 양방향 연결하기](/courses/ai-builder/35-mcp-tool-integration/) `MCP` `Google Drive` `파이프라인`
...
출처: [MCP로 AI를 Notion·Drive·DB에 양방향 연결하기](/courses/ai-builder/35-mcp-tool-integration/) `MCP` `검증` `Notion`
...
출처: [MCP로 AI를 Notion·Drive·DB에 양방향 연결하기](/courses/ai-builder/35-mcp-tool-integration/) `MCP` `예시` `액션아이템`
...
출처: [MVP 범위 정하기](/courses/ai-builder/41-mvp-scoping/) `MVP` `범위` `핵심 압축`
...
출처: [MVP 범위 정하기](/courses/ai-builder/41-mvp-scoping/) `기능 나열` `엣지케이스`
...
출처: [MVP 범위 정하기](/courses/ai-builder/41-mvp-scoping/) `검증` `노코드` `표`
...
출처: [MVP 범위 정하기](/courses/ai-builder/41-mvp-scoping/) `범위 초과` `쳐내기`
...
출처: [청킹·임베딩으로 RAG 정확도 높이기](/courses/ai-builder/37-rag-chunking-embedding/) `RAG` `청킹` `전략설계`
...
출처: [청킹·임베딩으로 RAG 정확도 높이기](/courses/ai-builder/37-rag-chunking-embedding/) `RAG` `진단` `디버깅`
...
출처: [청킹·임베딩으로 RAG 정확도 높이기](/courses/ai-builder/37-rag-chunking-embedding/) `RAG` `튜닝` `top-k` `임계값`
...
출처: [청킹·임베딩으로 RAG 정확도 높이기](/courses/ai-builder/37-rag-chunking-embedding/) `RAG` `청킹` `표·목록`
...
출처: [내 문서 더미를 검색형 지식베이스(RAG)로 만들기](/courses/ai-builder/36-rag-knowledge-base/) `환각 방지` `근거` `출처`
...
출처: [내 문서 더미를 검색형 지식베이스(RAG)로 만들기](/courses/ai-builder/36-rag-knowledge-base/) `정책 조회` `출처`
...
출처: [내 문서 더미를 검색형 지식베이스(RAG)로 만들기](/courses/ai-builder/36-rag-knowledge-base/) `문서 비교` `충돌 탐지` `출처`
...
출처: [내 문서 더미를 검색형 지식베이스(RAG)로 만들기](/courses/ai-builder/36-rag-knowledge-base/) `FAQ 생성` `신입 교육` `출처`
...
출처: [사용자 피드백으로 개선하기](/courses/ai-builder/43-user-feedback-iteration/) `프롬프트` `사용성 테스트` `대본`
...
출처: [사용자 피드백으로 개선하기](/courses/ai-builder/43-user-feedback-iteration/) `프롬프트` `우선순위` `관찰·인터뷰·지표`
...
출처: [사용자 피드백으로 개선하기](/courses/ai-builder/43-user-feedback-iteration/) `프롬프트` `인터뷰` `문제 정의`
...
출처: [API 키와 환경변수 안전 관리](/courses/ai-engineer/08-api-key-management/) `API 키` `환경변수` `.env` `분리`
...
출처: [API 키와 환경변수 안전 관리](/courses/ai-engineer/08-api-key-management/) `API 키` `보안` `검사`
...
출처: [API 키와 환경변수 안전 관리](/courses/ai-engineer/08-api-key-management/) `API 키` `노출` `폐기`
...
출처: [API 키와 환경변수 안전 관리](/courses/ai-engineer/08-api-key-management/) `환경변수` `.env.example` `팀 공유`
...
출처: [비동기 기초: 여러 호출 동시 처리](/courses/ai-engineer/07-async-basics/) `비동기` `코드 변환` `gather`
...
출처: [비동기 기초: 여러 호출 동시 처리](/courses/ai-engineer/07-async-basics/) `비동기` `개념` `학습`
...
출처: [비동기 기초: 여러 호출 동시 처리](/courses/ai-engineer/07-async-basics/) `비동기` `코드 리뷰`
...
출처: [비동기 기초: 여러 호출 동시 처리](/courses/ai-engineer/07-async-basics/) `비동기` `에러` `디버깅`
...
출처: [개발 환경 세팅: 파이썬·venv·에디터](/courses/ai-engineer/01-dev-environment-setup/) `개발환경` `에러해결` `파이썬`
...
출처: [개발 환경 세팅: 파이썬·venv·에디터](/courses/ai-engineer/01-dev-environment-setup/) `개발환경` `venv` `명령어`
...
출처: [개발 환경 세팅: 파이썬·venv·에디터](/courses/ai-engineer/01-dev-environment-setup/) `개발환경` `pip` `패키지`
...
출처: [개발 환경 세팅: 파이썬·venv·에디터](/courses/ai-engineer/01-dev-environment-setup/) `개발환경` `VS Code` `인터프리터`
...
출처: [문서 청킹 전략](/courses/ai-engineer/25-document-chunking/) `청킹` `의미단위` `rag` `오버랩`
...
출처: [문서 청킹 전략](/courses/ai-engineer/25-document-chunking/) `청킹` `고정토큰` `베이스라인`
...
출처: [문서 청킹 전략](/courses/ai-engineer/25-document-chunking/) `청킹` `채점` `검색품질`
...
출처: [문서 청킹 전략](/courses/ai-engineer/25-document-chunking/) `청킹` `파라미터` `ab-test`
...
출처: [임베딩과 코사인 유사도](/courses/ai-engineer/26-embedding-cosine-similarity/) `임베딩` `벡터` `3D비유`
...
출처: [임베딩과 코사인 유사도](/courses/ai-engineer/26-embedding-cosine-similarity/) `코사인 유사도` `표`
...
출처: [임베딩과 코사인 유사도](/courses/ai-engineer/26-embedding-cosine-similarity/) `의미검색` `RAG`
...
출처: [임베딩과 코사인 유사도](/courses/ai-engineer/26-embedding-cosine-similarity/) `검산` `코사인 유사도`
...
출처: [오류 처리와 재시도 전략](/courses/ai-engineer/14-error-handling-retry/) `오류 처리` `재시도` `지수 백오프` `함수`
...
출처: [오류 처리와 재시도 전략](/courses/ai-engineer/14-error-handling-retry/) `리팩터링` `재시도` `타임아웃`
...
출처: [오류 처리와 재시도 전략](/courses/ai-engineer/14-error-handling-retry/) `오류 처리` `분류` `표`
...
출처: [오류 처리와 재시도 전략](/courses/ai-engineer/14-error-handling-retry/) `테스트` `재시도` `검증`
...
출처: [퓨샷 예시로 출력 학습시키기](/courses/ai-engineer/17-few-shot-examples/) `퓨샷` `형식 고정`
...
출처: [퓨샷 예시로 출력 학습시키기](/courses/ai-engineer/17-few-shot-examples/) `퓨샷` `예시 생성`
...
출처: [퓨샷 예시로 출력 학습시키기](/courses/ai-engineer/17-few-shot-examples/) `퓨샷` `경계 케이스`
...
출처: [퓨샷 예시로 출력 학습시키기](/courses/ai-engineer/17-few-shot-examples/) `퓨샷` `A/B 테스트`
...
출처: [첫 LLM API 호출 성공시키기](/courses/ai-engineer/10-first-llm-call/) `프롬프트` `응답 객체` `텍스트 추출`
...
출처: [첫 LLM API 호출 성공시키기](/courses/ai-engineer/10-first-llm-call/) `프롬프트` `에러 처리`
...
출처: [첫 LLM API 호출 성공시키기](/courses/ai-engineer/10-first-llm-call/) `프롬프트` `환경변수`
...
출처: [첫 LLM API 호출 성공시키기](/courses/ai-engineer/10-first-llm-call/) `프롬프트` `예제 코드`
...
출처: [함수·모듈로 코드 조직하기](/courses/ai-engineer/04-functions-and-modules/) `함수` `리팩터링` `쪼개기`
...
출처: [함수·모듈로 코드 조직하기](/courses/ai-engineer/04-functions-and-modules/) `모듈` `패키지` `구조 설계`
...
출처: [함수·모듈로 코드 조직하기](/courses/ai-engineer/04-functions-and-modules/) `함수` `이름` `인자`
...
출처: [함수·모듈로 코드 조직하기](/courses/ai-engineer/04-functions-and-modules/) `docstring` `문서화`
...
출처: [HTTP 요청 보내기: requests 기초](/courses/ai-engineer/06-http-requests/) `코드리뷰` `requests` `에러처리`
...
출처: [HTTP 요청 보내기: requests 기초](/courses/ai-engineer/06-http-requests/) `변환` `curl` `requests`
...
출처: [HTTP 요청 보내기: requests 기초](/courses/ai-engineer/06-http-requests/) `디버깅` `에러` `상태코드`
...
출처: [HTTP 요청 보내기: requests 기초](/courses/ai-engineer/06-http-requests/) `학습자료` `공개API` `연습`
...
출처: [JSON 다루기: LLM 응답 파싱](/courses/ai-engineer/05-json-parsing/) `JSON` `출력형식` `LLM 응답`
...
출처: [JSON 다루기: LLM 응답 파싱](/courses/ai-engineer/05-json-parsing/) `JSON` `디버깅` `json.loads`
...
출처: [JSON 다루기: LLM 응답 파싱](/courses/ai-engineer/05-json-parsing/) `JSON` `중첩 JSON` `dict.get`
...
출처: [JSON 다루기: LLM 응답 파싱](/courses/ai-engineer/05-json-parsing/) `JSON` `구조 이해` `학습`
...
출처: [JSON 스키마 검증과 재시도](/courses/ai-engineer/20-json-schema-validation/) `검증` `재시도` `함수생성`
...
출처: [JSON 스키마 검증과 재시도](/courses/ai-engineer/20-json-schema-validation/) `스키마` `pydantic`
...
출처: [JSON 스키마 검증과 재시도](/courses/ai-engineer/20-json-schema-validation/) `instructor` `리팩터링`
...
출처: [JSON 스키마 검증과 재시도](/courses/ai-engineer/20-json-schema-validation/) `테스트` `pytest` `실패케이스`
...
출처: [AI API로 앱 만들기 — Claude/OpenAI API 직접 호출](/courses/ai-engineer/09-llm-api-app/) `코드` `기본 호출` `복붙`
...
출처: [AI API로 앱 만들기 — Claude/OpenAI API 직접 호출](/courses/ai-engineer/09-llm-api-app/) `코드` `역할 지정` `system`
...
출처: [AI API로 앱 만들기 — Claude/OpenAI API 직접 호출](/courses/ai-engineer/09-llm-api-app/) `코드` `반복문` `자동화`
...
출처: [메시지 역할과 멀티턴 대화](/courses/ai-engineer/11-message-roles-multiturn/) `프롬프트` `messages 배열` `멀티턴`
...
출처: [메시지 역할과 멀티턴 대화](/courses/ai-engineer/11-message-roles-multiturn/) `프롬프트` `점검`
...
출처: [메시지 역할과 멀티턴 대화](/courses/ai-engineer/11-message-roles-multiturn/) `프롬프트` `system 프롬프트` `비교`
...
출처: [메시지 역할과 멀티턴 대화](/courses/ai-engineer/11-message-roles-multiturn/) `프롬프트` `요약` `토큰`
...
출처: [다중 도구와 도구 루프](/courses/ai-engineer/22-multi-tool-loop/) `도구 루프` `코드 생성` `에이전트`
...
출처: [다중 도구와 도구 루프](/courses/ai-engineer/22-multi-tool-loop/) `description` `도구 스키마`
...
출처: [다중 도구와 도구 루프](/courses/ai-engineer/22-multi-tool-loop/) `디버깅` `무한루프` `도구 루프`
...
출처: [다중 도구와 도구 루프](/courses/ai-engineer/22-multi-tool-loop/) `도구 추가` `다중 도구`
...
출처: [프롬프트 해부: 5대 구성요소](/courses/ai-engineer/15-prompt-anatomy/) `프롬프트` `5요소` `완성`
...
출처: [프롬프트 해부: 5대 구성요소](/courses/ai-engineer/15-prompt-anatomy/) `프롬프트` `진단` `5요소`
...
출처: [프롬프트 해부: 5대 구성요소](/courses/ai-engineer/15-prompt-anatomy/) `프롬프트` `변형` `실험`
...
출처: [프롬프트 해부: 5대 구성요소](/courses/ai-engineer/15-prompt-anatomy/) `프롬프트` `제약` `다듬기`
...
출처: [프롬프트 해부: 5대 구성요소](/courses/ai-engineer/15-prompt-anatomy/) `프롬프트` `예시` `완성`
...
출처: [컨텍스트·프롬프트 캐싱 — 비용·속도 최적화](/courses/ai-engineer/24-prompt-caching/) `프롬프트 캐싱` `cache_control` `문서 Q&A`
...
출처: [컨텍스트·프롬프트 캐싱 — 비용·속도 최적화](/courses/ai-engineer/24-prompt-caching/) `프롬프트 캐싱` `few-shot` `분류`
...
출처: [컨텍스트·프롬프트 캐싱 — 비용·속도 최적화](/courses/ai-engineer/24-prompt-caching/) `프롬프트 캐싱` `ttl` `베타 헤더`
...
출처: [컨텍스트·프롬프트 캐싱 — 비용·속도 최적화](/courses/ai-engineer/24-prompt-caching/) `프롬프트 캐싱` `usage` `검증`
...
출처: [프롬프트 반복 개선·디버깅](/courses/ai-engineer/18-prompt-debugging/) `프롬프트 디버깅` `실패 로그` `유형 분류`
...
출처: [프롬프트 반복 개선·디버깅](/courses/ai-engineer/18-prompt-debugging/) `프롬프트 디버깅` `규칙 추가` `한 번에 하나씩`
...
출처: [프롬프트 반복 개선·디버깅](/courses/ai-engineer/18-prompt-debugging/) `A/B 비교` `심판` `기준`
...
출처: [프롬프트 반복 개선·디버깅](/courses/ai-engineer/18-prompt-debugging/) `회귀 테스트` `재검증` `일괄 실행`
...
출처: [파이썬 기초 — AI·자동화의 공용어](/courses/ai-engineer/02-python-basics/) `파이썬` `코드 생성` `초보`
...
출처: [파이썬 기초 — AI·자동화의 공용어](/courses/ai-engineer/02-python-basics/) `파이썬` `디버깅` `에러`
...
출처: [파이썬 기초 — AI·자동화의 공용어](/courses/ai-engineer/02-python-basics/) `파이썬` `코드 해설`
...
출처: [파이썬 기초 — AI·자동화의 공용어](/courses/ai-engineer/02-python-basics/) `파이썬` `예시` `연습`
...
출처: [파이썬 자료구조: 리스트·딕셔너리](/courses/ai-engineer/03-python-data-structures/) `프롬프트` `파싱` `API`
...
출처: [파이썬 자료구조: 리스트·딕셔너리](/courses/ai-engineer/03-python-data-structures/) `프롬프트` `자료구조` `선택`
...
출처: [파이썬 자료구조: 리스트·딕셔너리](/courses/ai-engineer/03-python-data-structures/) `프롬프트` `컴프리헨션`
...
출처: [파이썬 자료구조: 리스트·딕셔너리](/courses/ai-engineer/03-python-data-structures/) `프롬프트` `에러` `디버깅`
...
출처: [추론 모델·확장 사고 — 언제 깊게 생각시키나](/courses/ai-engineer/23-reasoning-thinking-mode/) `추론 모드` `단계 풀이` `검산`
...
출처: [추론 모델·확장 사고 — 언제 깊게 생각시키나](/courses/ai-engineer/23-reasoning-thinking-mode/) `모드 선택` `판단`
...
출처: [추론 모델·확장 사고 — 언제 깊게 생각시키나](/courses/ai-engineer/23-reasoning-thinking-mode/) `검증` `검산` `재검토`
...
출처: [추론 모델·확장 사고 — 언제 깊게 생각시키나](/courses/ai-engineer/23-reasoning-thinking-mode/) `예시` `연립방정식` `단계 풀이`
...
출처: [스트리밍 응답으로 실시간 출력](/courses/ai-engineer/12-streaming-responses/) `프롬프트` `스트리밍` `Node.js`
...
출처: [스트리밍 응답으로 실시간 출력](/courses/ai-engineer/12-streaming-responses/) `프롬프트` `스트리밍` `UI`
...
출처: [스트리밍 응답으로 실시간 출력](/courses/ai-engineer/12-streaming-responses/) `프롬프트` `에러처리` `AbortController`
...
출처: [스트리밍 응답으로 실시간 출력](/courses/ai-engineer/12-streaming-responses/) `프롬프트` `delta` `provider`
...
출처: [구조화 출력·함수호출 — AI 응답을 코드가 쓰게](/courses/ai-engineer/19-structured-output-function-calling/) `프롬프트` `구조화출력` `JSON`
...
출처: [구조화 출력·함수호출 — AI 응답을 코드가 쓰게](/courses/ai-engineer/19-structured-output-function-calling/) `프롬프트` `TSV` `구글시트`
...
출처: [구조화 출력·함수호출 — AI 응답을 코드가 쓰게](/courses/ai-engineer/19-structured-output-function-calling/) `프롬프트` `추출` `JSON`
...
출처: [구조화 출력·함수호출 — AI 응답을 코드가 쓰게](/courses/ai-engineer/19-structured-output-function-calling/) `프롬프트` `분류` `라벨링`
...
출처: [시스템 프롬프트로 행동 통제](/courses/ai-engineer/16-system-prompt-control/) `프롬프트` `system` `초안 강화`
...
출처: [시스템 프롬프트로 행동 통제](/courses/ai-engineer/16-system-prompt-control/) `프롬프트` `템플릿` `4대 구성요소`
...
출처: [시스템 프롬프트로 행동 통제](/courses/ai-engineer/16-system-prompt-control/) `프롬프트` `스트레스 테스트`
...
출처: [시스템 프롬프트로 행동 통제](/courses/ai-engineer/16-system-prompt-control/) `프롬프트` `관찰 가능한 행동`
...
출처: [토큰과 API 비용 통제](/courses/ai-engineer/13-token-cost-control/) `비용계산` `토큰` `견적`
...
출처: [토큰과 API 비용 통제](/courses/ai-engineer/13-token-cost-control/) `프롬프트다이어트` `토큰절감`
...
출처: [토큰과 API 비용 통제](/courses/ai-engineer/13-token-cost-control/) `max_tokens` `출력상한`
...
출처: [토큰과 API 비용 통제](/courses/ai-engineer/13-token-cost-control/) `비용시뮬레이션` `예산`
...
출처: [도구 호출(tool use) 첫 사이클](/courses/ai-engineer/21-tool-use-first-cycle/) `tool-use` `스키마` `함수 변환`
...
출처: [도구 호출(tool use) 첫 사이클](/courses/ai-engineer/21-tool-use-first-cycle/) `tool-use` `코드` `뼈대`
...
출처: [도구 호출(tool use) 첫 사이클](/courses/ai-engineer/21-tool-use-first-cycle/) `tool-use` `디버깅` `tool-use-id`
...
출처: [AI란 무엇인가 — 똑똑한 기계의 정체 이해](/courses/ai-intro/01-what-is-ai/) `AI 리터러시` `설명`
...
출처: [AI란 무엇인가 — 똑똑한 기계의 정체 이해](/courses/ai-intro/01-what-is-ai/) `AI 리터러시`
...
출처: [AI 핵심 용어 — 토큰·프롬프트·컨텍스트·모델](/courses/ai-intro/02-core-terms/) `프롬프트` `만능`
...
출처: [AI 핵심 용어 — 토큰·프롬프트·컨텍스트·모델](/courses/ai-intro/02-core-terms/) `프롬프트` `요약`
...
출처: [AI 핵심 용어 — 토큰·프롬프트·컨텍스트·모델](/courses/ai-intro/02-core-terms/) `프롬프트` `정확`
...
출처: [AI 핵심 용어 — 토큰·프롬프트·컨텍스트·모델](/courses/ai-intro/02-core-terms/) `프롬프트` `창의`
...
출처: [AI 챗봇 시작하기: 계정 만들고 열기](/courses/ai-intro/03-start-chatbot/) `시작` `활용법`
...
출처: [AI 챗봇 시작하기: 계정 만들고 열기](/courses/ai-intro/03-start-chatbot/) `시작` `선택`
...
출처: [AI 챗봇 시작하기: 계정 만들고 열기](/courses/ai-intro/03-start-chatbot/) `시작` `문제해결`
...
출처: [AI 챗봇 시작하기: 계정 만들고 열기](/courses/ai-intro/03-start-chatbot/) `시작` `실전`
...
출처: [명령(프롬프트)이 무엇인지 이해하기](/courses/ai-intro/04-what-is-prompt/) `이미지` `기초`
...
출처: [명령(프롬프트)이 무엇인지 이해하기](/courses/ai-intro/04-what-is-prompt/) `이미지` `실험`
...
출처: [첫 대화 보내기](/courses/ai-intro/05-send-first-message/) `시작` `대화`
...
출처: [첫 대화 보내기](/courses/ai-intro/05-send-first-message/) `대화` `후속질문`
...
출처: [첫 대화 보내기](/courses/ai-intro/05-send-first-message/) `대화` `다듬기`
...
출처: [첫 대화 보내기](/courses/ai-intro/05-send-first-message/) `대화` `주제전환`
...
출처: [LLM 작동 원리 — AI는 어떻게 글을 만드나](/courses/ai-intro/06-how-llm-works/) `환각` `안전`
...
출처: [LLM 작동 원리 — AI는 어떻게 글을 만드나](/courses/ai-intro/06-how-llm-works/) `환각` `검증`
...
출처: [LLM 작동 원리 — AI는 어떻게 글을 만드나](/courses/ai-intro/06-how-llm-works/) `설명` `학습`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-intro/07-clear-one-sentence-prompt/) `프롬프트` `템플릿`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-intro/07-clear-one-sentence-prompt/) `프롬프트` `설명`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-intro/07-clear-one-sentence-prompt/) `프롬프트` `글쓰기`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-intro/07-clear-one-sentence-prompt/) `프롬프트` `수정`
...
출처: [좋은 프롬프트의 4요소](/courses/ai-intro/08-four-elements/) `프롬프트` `만능` `4요소`
...
출처: [좋은 프롬프트의 4요소](/courses/ai-intro/08-four-elements/) `프롬프트` `점검`
...
출처: [좋은 프롬프트의 4요소](/courses/ai-intro/08-four-elements/) `프롬프트` `맥락`
...
출처: [좋은 프롬프트의 4요소](/courses/ai-intro/08-four-elements/) `프롬프트` `형식`
...
출처: [맥락과 배경 제공하기](/courses/ai-intro/09-provide-context/) `프롬프트` `맥락`
...
출처: [맥락과 배경 제공하기](/courses/ai-intro/09-provide-context/) `프롬프트` `이메일`
...
출처: [맥락과 배경 제공하기](/courses/ai-intro/09-provide-context/) `프롬프트` `설명`
...
출처: [초보가 흔히 하는 프롬프트 실수](/courses/ai-intro/10-common-mistakes/) `프롬프트` `진단`
...
출처: [초보가 흔히 하는 프롬프트 실수](/courses/ai-intro/10-common-mistakes/) `프롬프트` `틀`
...
출처: [초보가 흔히 하는 프롬프트 실수](/courses/ai-intro/10-common-mistakes/) `프롬프트` `분할`
...
출처: [초보가 흔히 하는 프롬프트 실수](/courses/ai-intro/10-common-mistakes/) `프롬프트` `톤`
...
출처: [후속 질문으로 답 다듬기](/courses/ai-intro/11-follow-up-refine/) `다듬기` `길이` `말투`
...
출처: [후속 질문으로 답 다듬기](/courses/ai-intro/11-follow-up-refine/) `다듬기` `예시`
...
출처: [후속 질문으로 답 다듬기](/courses/ai-intro/11-follow-up-refine/) `다듬기` `격식`
...
출처: [후속 질문으로 답 다듬기](/courses/ai-intro/11-follow-up-refine/) `다듬기` `되돌리기`
...
출처: [출력 형식 지정하기](/courses/ai-intro/12-output-format/) `형식` `표`
...
출처: [출력 형식 지정하기](/courses/ai-intro/12-output-format/) `형식` `목록`
...
출처: [출력 형식 지정하기](/courses/ai-intro/12-output-format/) `형식` `JSON`
...
출처: [출력 형식 지정하기](/courses/ai-intro/12-output-format/) `형식` `SNS`
...
출처: [역할 부여하기](/courses/ai-intro/13-assign-role/) `역할` `기본`
...
출처: [역할 부여하기](/courses/ai-intro/13-assign-role/) `역할` `비교`
...
출처: [역할 부여하기](/courses/ai-intro/13-assign-role/) `역할` `페르소나`
...
출처: [역할 부여하기](/courses/ai-intro/13-assign-role/) `역할` `점검`
...
출처: [대화 맥락 관리하기](/courses/ai-intro/14-manage-context/) `맥락` `이어가기`
...
출처: [대화 맥락 관리하기](/courses/ai-intro/14-manage-context/) `맥락` `요약`
...
출처: [대화 맥락 관리하기](/courses/ai-intro/14-manage-context/) `맥락` `새 대화`
...
출처: [대화 맥락 관리하기](/courses/ai-intro/14-manage-context/) `맥락` `초기화`
...
출처: [단계적으로 생각하게 시키기](/courses/ai-intro/15-step-by-step/) `추론` `단계별`
...
출처: [단계적으로 생각하게 시키기](/courses/ai-intro/15-step-by-step/) `추론` `검산`
...
출처: [단계적으로 생각하게 시키기](/courses/ai-intro/15-step-by-step/) `추론` `의사결정`
...
출처: [단계적으로 생각하게 시키기](/courses/ai-intro/15-step-by-step/) `추론` `점검`
...
출처: [예시로 원하는 결과 보여주기](/courses/ai-intro/16-few-shot-examples/) `few-shot` `예시`
...
출처: [예시로 원하는 결과 보여주기](/courses/ai-intro/16-few-shot-examples/) `few-shot` `정확도`
...
출처: [예시로 원하는 결과 보여주기](/courses/ai-intro/16-few-shot-examples/) `few-shot` `생성`
...
출처: [예시로 원하는 결과 보여주기](/courses/ai-intro/16-few-shot-examples/) `few-shot` `형식`
...
출처: [프롬프트 고쳐 쓰며 디버깅하기](/courses/ai-intro/17-prompt-debugging/) `디버깅` `진단`
...
출처: [프롬프트 고쳐 쓰며 디버깅하기](/courses/ai-intro/17-prompt-debugging/) `디버깅` `수정`
...
출처: [프롬프트 고쳐 쓰며 디버깅하기](/courses/ai-intro/17-prompt-debugging/) `디버깅` `비교`
...
출처: [프롬프트 고쳐 쓰며 디버깅하기](/courses/ai-intro/17-prompt-debugging/) `디버깅` `템플릿`
...
출처: [AI도 틀린다 — AI 답을 무조건 믿지 않기](/courses/ai-intro/18-ai-can-be-wrong/) `환각` `실험`
...
출처: [AI도 틀린다 — AI 답을 무조건 믿지 않기](/courses/ai-intro/18-ai-can-be-wrong/) `환각` `검증`
...
출처: [AI도 틀린다 — AI 답을 무조건 믿지 않기](/courses/ai-intro/18-ai-can-be-wrong/) `환각` `출처`
...
출처: [환각(그럴듯한 거짓) 알아채기](/courses/ai-intro/19-spot-hallucination/) `환각` `검증`
...
출처: [환각(그럴듯한 거짓) 알아채기](/courses/ai-intro/19-spot-hallucination/) `환각` `안전`
...
출처: [환각(그럴듯한 거짓) 알아채기](/courses/ai-intro/19-spot-hallucination/) `환각` `인용`
...
출처: [환각(그럴듯한 거짓) 알아채기](/courses/ai-intro/19-spot-hallucination/) `환각` `교차검증`
...
출처: [출처 요구하고 직접 확인하기](/courses/ai-intro/20-verify-sources/) `출처` `검증`
...
출처: [출처 요구하고 직접 확인하기](/courses/ai-intro/20-verify-sources/) `출처` `자가점검`
...
출처: [출처 요구하고 직접 확인하기](/courses/ai-intro/20-verify-sources/) `출처` `판정`
...
출처: [출처 요구하고 직접 확인하기](/courses/ai-intro/20-verify-sources/) `출처` `재작성`
...
출처: [교차검증 워크플로](/courses/ai-intro/21-cross-verification/) `교차검증` `확신도`
...
출처: [교차검증 워크플로](/courses/ai-intro/21-cross-verification/) `교차검증` `백지`
...
출처: [교차검증 워크플로](/courses/ai-intro/21-cross-verification/) `교차검증` `출처`
...
출처: [교차검증 워크플로](/courses/ai-intro/21-cross-verification/) `교차검증` `규칙`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-intro/22-understand-topic/) `학습` `설명`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-intro/22-understand-topic/) `학습` `되묻기`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-intro/22-understand-topic/) `학습` `요약` `노트`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-intro/22-understand-topic/) `학습` `기사`
...
출처: [눈높이 설명 요청하기](/courses/ai-intro/23-eli5-explanation/) `설명` `비유`
...
출처: [눈높이 설명 요청하기](/courses/ai-intro/23-eli5-explanation/) `설명` `되묻기`
...
출처: [눈높이 설명 요청하기](/courses/ai-intro/23-eli5-explanation/) `설명` `검증`
...
출처: [눈높이 설명 요청하기](/courses/ai-intro/23-eli5-explanation/) `설명` `예시`
...
출처: [AI로 스스로 퀴즈 내기](/courses/ai-intro/24-self-quiz/) `학습` `퀴즈`
...
출처: [AI로 스스로 퀴즈 내기](/courses/ai-intro/24-self-quiz/) `학습` `채점`
...
출처: [AI로 스스로 퀴즈 내기](/courses/ai-intro/24-self-quiz/) `학습` `재시험`
...
출처: [AI로 스스로 퀴즈 내기](/courses/ai-intro/24-self-quiz/) `학습` `복습`
...
출처: [AI와 학습 계획 세우기](/courses/ai-intro/25-learning-plan/) `학습계획` `로드맵`
...
출처: [AI와 학습 계획 세우기](/courses/ai-intro/25-learning-plan/) `학습계획` `조정`
...
출처: [AI와 학습 계획 세우기](/courses/ai-intro/25-learning-plan/) `학습계획` `산출물`
...
출처: [AI와 학습 계획 세우기](/courses/ai-intro/25-learning-plan/) `학습계획` `실행`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-intro/26-email-draft/) `이메일` `실무`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-intro/26-email-draft/) `이메일` `부탁`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-intro/26-email-draft/) `이메일` `사과`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-intro/26-email-draft/) `이메일` `번역` `영어`
...
출처: [내가 쓴 글 다듬기](/courses/ai-intro/27-polish-writing/) `글쓰기` `편집`
...
출처: [내가 쓴 글 다듬기](/courses/ai-intro/27-polish-writing/) `글쓰기` `톤`
...
출처: [내가 쓴 글 다듬기](/courses/ai-intro/27-polish-writing/) `글쓰기` `버전`
...
출처: [내가 쓴 글 다듬기](/courses/ai-intro/27-polish-writing/) `글쓰기` `학습`
...
출처: [어조와 격식 조절하기](/courses/ai-intro/28-tone-formality/) `어조` `격식`
...
출처: [어조와 격식 조절하기](/courses/ai-intro/28-tone-formality/) `어조` `매체`
...
출처: [어조와 격식 조절하기](/courses/ai-intro/28-tone-formality/) `어조` `프리셋`
...
출처: [긴 글 초안 만들기(공지·보고)](/courses/ai-intro/29-long-draft/) `글쓰기` `공지`
...
출처: [긴 글 초안 만들기(공지·보고)](/courses/ai-intro/29-long-draft/) `글쓰기` `제목`
...
출처: [긴 글 초안 만들기(공지·보고)](/courses/ai-intro/29-long-draft/) `글쓰기` `보고서`
...
출처: [긴 글 초안 만들기(공지·보고)](/courses/ai-intro/29-long-draft/) `글쓰기` `축약`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-intro/30-summarize-doc/) `요약` `회의록`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-intro/30-summarize-doc/) `요약` `기사`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-intro/30-summarize-doc/) `요약` `계약서` `법률`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-intro/30-summarize-doc/) `요약` `표` `할일`
...
출처: [핵심 요점만 뽑아내기](/courses/ai-intro/31-extract-key-points/) `요약` `요점`
...
출처: [핵심 요점만 뽑아내기](/courses/ai-intro/31-extract-key-points/) `요약` `행동항목`
...
출처: [핵심 요점만 뽑아내기](/courses/ai-intro/31-extract-key-points/) `요약` `회의록`
...
출처: [핵심 요점만 뽑아내기](/courses/ai-intro/31-extract-key-points/) `요약` `좁히기`
...
출처: [문서에 질문 던지기](/courses/ai-intro/32-ask-documents/) `문서` `근거`
...
출처: [문서에 질문 던지기](/courses/ai-intro/32-ask-documents/) `문서` `검증`
...
출처: [문서에 질문 던지기](/courses/ai-intro/32-ask-documents/) `문서` `조건`
...
출처: [문서에 질문 던지기](/courses/ai-intro/32-ask-documents/) `문서` `정리`
...
출처: [표와 데이터로 정리하기](/courses/ai-intro/33-tables-data/) `표` `데이터`
...
출처: [표와 데이터로 정리하기](/courses/ai-intro/33-tables-data/) `표` `필터`
...
출처: [표와 데이터로 정리하기](/courses/ai-intro/33-tables-data/) `표` `CSV`
...
출처: [표와 데이터로 정리하기](/courses/ai-intro/33-tables-data/) `표` `비교`
...
출처: [내 정보를 지키며 AI를 안전하게 쓴다](/courses/ai-intro/34-use-ai-safely/) `안전` `학습`
...
출처: [내 정보를 지키며 AI를 안전하게 쓴다](/courses/ai-intro/34-use-ai-safely/) `안전` `점검`
...
출처: [내 정보를 지키며 AI를 안전하게 쓴다](/courses/ai-intro/34-use-ai-safely/) `안전` `놀이`
...
출처: [AI에 넣으면 안 되는 정보](/courses/ai-intro/35-what-not-to-input/) `안전` `치환`
...
출처: [AI에 넣으면 안 되는 정보](/courses/ai-intro/35-what-not-to-input/) `안전` `점검`
...
출처: [AI에 넣으면 안 되는 정보](/courses/ai-intro/35-what-not-to-input/) `안전` `질문`
...
출처: [AI에 넣으면 안 되는 정보](/courses/ai-intro/35-what-not-to-input/) `안전` `규칙`
...
출처: [AI의 편향 인식하기](/courses/ai-intro/36-recognize-bias/) `편향` `재질문`
...
출처: [AI의 편향 인식하기](/courses/ai-intro/36-recognize-bias/) `편향` `재작성`
...
출처: [AI의 편향 인식하기](/courses/ai-intro/36-recognize-bias/) `편향` `실험`
...
출처: [AI의 편향 인식하기](/courses/ai-intro/36-recognize-bias/) `편향` `누락`
...
출처: [AI 사용 밝히기와 표절 피하기](/courses/ai-intro/37-disclose-ai-plagiarism/) `윤리` `고지`
...
출처: [AI 사용 밝히기와 표절 피하기](/courses/ai-intro/37-disclose-ai-plagiarism/) `윤리` `표절`
...
출처: [AI 사용 밝히기와 표절 피하기](/courses/ai-intro/37-disclose-ai-plagiarism/) `윤리` `재작성`
...
출처: [AI 사용 밝히기와 표절 피하기](/courses/ai-intro/37-disclose-ai-plagiarism/) `윤리` `규칙`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-intro/38-first-image/) `이미지` `SNS`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-intro/38-first-image/) `이미지` `수정`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-intro/38-first-image/) `이미지` `일러스트`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-intro/38-first-image/) `이미지` `스타일`
...
출처: [이미지 프롬프트의 구성 요소](/courses/ai-intro/39-image-prompt-parts/) `이미지` `프롬프트`
...
출처: [이미지 프롬프트의 구성 요소](/courses/ai-intro/39-image-prompt-parts/) `이미지` `아이디어`
...
출처: [이미지 프롬프트의 구성 요소](/courses/ai-intro/39-image-prompt-parts/) `이미지` `수정`
...
출처: [이미지 프롬프트의 구성 요소](/courses/ai-intro/39-image-prompt-parts/) `이미지` `스타일`
...
출처: [이미지 다듬고 스타일 반복하기](/courses/ai-intro/40-iterate-images/) `이미지` `기준`
...
출처: [이미지 다듬고 스타일 반복하기](/courses/ai-intro/40-iterate-images/) `이미지` `스타일`
...
출처: [이미지 다듬고 스타일 반복하기](/courses/ai-intro/40-iterate-images/) `이미지` `요소`
...
출처: [이미지 다듬고 스타일 반복하기](/courses/ai-intro/40-iterate-images/) `이미지` `비율`
...
출처: [AI 모델 고르기 — 언제 뭘 쓰나](/courses/ai-intro/41-choosing-models/) `모델선택` `비교`
...
출처: [AI 모델 고르기 — 언제 뭘 쓰나](/courses/ai-intro/41-choosing-models/) `모델선택` `글쓰기`
...
출처: [AI 모델 고르기 — 언제 뭘 쓰나](/courses/ai-intro/41-choosing-models/) `모델선택` `검색`
...
출처: [AI 모델 고르기 — 언제 뭘 쓰나](/courses/ai-intro/41-choosing-models/) `모델선택` `추론`
...
출처: [무료와 유료 AI의 차이](/courses/ai-intro/42-free-vs-paid/) `요금` `비교`
...
출처: [무료와 유료 AI의 차이](/courses/ai-intro/42-free-vs-paid/) `요금` `판단표`
...
출처: [무료와 유료 AI의 차이](/courses/ai-intro/42-free-vs-paid/) `요금` `최적화`
...
출처: [무료와 유료 AI의 차이](/courses/ai-intro/42-free-vs-paid/) `요금` `진단`
...
출처: [작업에 맞는 AI 도구 고르기](/courses/ai-intro/43-match-tool-to-task/) `도구조합` `조사`
...
출처: [작업에 맞는 AI 도구 고르기](/courses/ai-intro/43-match-tool-to-task/) `도구조합` `초안`
...
출처: [작업에 맞는 AI 도구 고르기](/courses/ai-intro/43-match-tool-to-task/) `도구조합` `이미지`
...
출처: [작업에 맞는 AI 도구 고르기](/courses/ai-intro/43-match-tool-to-task/) `도구조합` `검토`
...
출처: [캡스톤: 첫 결과물 완성하기](/courses/ai-intro/44-capstone/) `캡스톤` `초안`
...
출처: [캡스톤: 첫 결과물 완성하기](/courses/ai-intro/44-capstone/) `캡스톤` `수정`
...
출처: [캡스톤: 첫 결과물 완성하기](/courses/ai-intro/44-capstone/) `캡스톤` `이미지`
...
출처: [캡스톤: 첫 결과물 완성하기](/courses/ai-intro/44-capstone/) `캡스톤` `보고서`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-start/01-email-draft/) `이메일` `실무`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-start/01-email-draft/) `이메일` `부탁`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-start/01-email-draft/) `이메일` `사과`
...
출처: [AI로 업무 이메일 초안 30초에 뽑기](/courses/ai-start/01-email-draft/) `이메일` `번역` `영어`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-start/02-summarize-doc/) `요약` `회의록`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-start/02-summarize-doc/) `요약` `기사`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-start/02-summarize-doc/) `요약` `계약서` `법률`
...
출처: [긴 문서 1개를 AI에 붙여넣어 핵심 요약 뽑기](/courses/ai-start/02-summarize-doc/) `요약` `표` `할일`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-start/03-first-image/) `이미지` `SNS`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-start/03-first-image/) `이미지` `수정`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-start/03-first-image/) `이미지` `일러스트`
...
출처: [AI로 첫 이미지 한 장 만들기](/courses/ai-start/03-first-image/) `이미지` `스타일`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-start/04-understand-topic/) `학습` `설명`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-start/04-understand-topic/) `학습` `되묻기`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-start/04-understand-topic/) `학습` `요약` `노트`
...
출처: [낯선 주제를 AI에게 물어 빠르게 이해하기](/courses/ai-start/04-understand-topic/) `학습` `기사`
...
출처: [명령(프롬프트)이 무엇인지 이해하기](/courses/ai-start/05-what-is-prompt/) `이미지` `기초`
...
출처: [명령(프롬프트)이 무엇인지 이해하기](/courses/ai-start/05-what-is-prompt/) `이미지` `실험`
...
출처: [AI도 틀린다 — AI 답을 무조건 믿지 않기](/courses/ai-start/06-ai-can-be-wrong/) `환각` `실험`
...
출처: [AI도 틀린다 — AI 답을 무조건 믿지 않기](/courses/ai-start/06-ai-can-be-wrong/) `환각` `검증`
...
출처: [AI도 틀린다 — AI 답을 무조건 믿지 않기](/courses/ai-start/06-ai-can-be-wrong/) `환각` `출처`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-start/07-clear-one-sentence-prompt/) `프롬프트` `템플릿`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-start/07-clear-one-sentence-prompt/) `프롬프트` `설명`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-start/07-clear-one-sentence-prompt/) `프롬프트` `글쓰기`
...
출처: [분명하고 친절한 한 문장 명령 쓰기](/courses/ai-start/07-clear-one-sentence-prompt/) `프롬프트` `수정`
...
출처: [AI 부업 시작하기 — 첫 1만원 버는 길](/courses/ai-start/08-first-income/) `부업` `아이디어`
...
출처: [프롬프트 4요소 해부](/courses/ai-work/01-prompt-4-elements/) `프롬프트` `4요소` `템플릿`
...
출처: [프롬프트 4요소 해부](/courses/ai-work/01-prompt-4-elements/) `프롬프트` `진단` `점검`
...
출처: [프롬프트 4요소 해부](/courses/ai-work/01-prompt-4-elements/) `프롬프트` `리라이트`
...
출처: [프롬프트 4요소 해부](/courses/ai-work/01-prompt-4-elements/) `프롬프트` `형식`
...
출처: [역할·맥락·형식·예시를 갖춘 구조화된 명령서 설계](/courses/ai-work/02-structured-command/) `프롬프트` `6칸` `만능`
...
출처: [역할·맥락·형식·예시를 갖춘 구조화된 명령서 설계](/courses/ai-work/02-structured-command/) `프롬프트` `글쓰기`
...
출처: [역할·맥락·형식·예시를 갖춘 구조화된 명령서 설계](/courses/ai-work/02-structured-command/) `프롬프트` `비교` `강화`
...
출처: [역할과 맥락 심기](/courses/ai-work/03-role-context/) `프롬프트` `역할` `맥락`
...
출처: [역할과 맥락 심기](/courses/ai-work/03-role-context/) `프롬프트` `비교`
...
출처: [역할과 맥락 심기](/courses/ai-work/03-role-context/) `프롬프트` `역할`
...
출처: [역할과 맥락 심기](/courses/ai-work/03-role-context/) `프롬프트` `맥락` `점검`
...
출처: [출력 형식 지시하기](/courses/ai-work/04-output-format/) `프롬프트` `출력형식` `표`
...
출처: [출력 형식 지시하기](/courses/ai-work/04-output-format/) `프롬프트` `출력형식` `불릿`
...
출처: [출력 형식 지시하기](/courses/ai-work/04-output-format/) `프롬프트` `출력형식` `json`
...
출처: [출력 형식 지시하기](/courses/ai-work/04-output-format/) `프롬프트` `출력형식` `말투`
...
출처: [예시로 결과 고정하기(few-shot)](/courses/ai-work/05-few-shot/) `프롬프트` `few-shot` `만능`
...
출처: [예시로 결과 고정하기(few-shot)](/courses/ai-work/05-few-shot/) `프롬프트` `few-shot` `고객답변`
...
출처: [예시로 결과 고정하기(few-shot)](/courses/ai-work/05-few-shot/) `프롬프트` `few-shot` `카피`
...
출처: [예시로 결과 고정하기(few-shot)](/courses/ai-work/05-few-shot/) `프롬프트` `few-shot` `형식변환`
...
출처: [프롬프트 디버깅 루프](/courses/ai-work/06-prompt-debugging/) `프롬프트` `디버깅` `진단`
...
출처: [프롬프트 디버깅 루프](/courses/ai-work/06-prompt-debugging/) `프롬프트` `디버깅` `변인통제`
...
출처: [프롬프트 디버깅 루프](/courses/ai-work/06-prompt-debugging/) `프롬프트` `예시` `톤`
...
출처: [프롬프트 디버깅 루프](/courses/ai-work/06-prompt-debugging/) `프롬프트` `템플릿` `재사용`
...
출처: [프롬프트 심화 패턴 — few-shot·CoT·ReAct](/courses/ai-work/07-advanced-patterns/) `프롬프트` `few-shot` `예시`
...
출처: [프롬프트 심화 패턴 — few-shot·CoT·ReAct](/courses/ai-work/07-advanced-patterns/) `프롬프트` `chain-of-thought` `추론`
...
출처: [프롬프트 심화 패턴 — few-shot·CoT·ReAct](/courses/ai-work/07-advanced-patterns/) `프롬프트` `system` `역할`
...
출처: [프롬프트 심화 패턴 — few-shot·CoT·ReAct](/courses/ai-work/07-advanced-patterns/) `프롬프트` `ReAct` `웹검색`
...
출처: [AI로 업무 이메일 초안](/courses/ai-work/08-business-email/) `이메일` `초안` `뼈대`
...
출처: [AI로 업무 이메일 초안](/courses/ai-work/08-business-email/) `이메일` `톤` `길이`
...
출처: [AI로 업무 이메일 초안](/courses/ai-work/08-business-email/) `이메일` `제목`
...
출처: [AI로 업무 이메일 초안](/courses/ai-work/08-business-email/) `이메일` `답장`
...
출처: [내가 쓴 글 교정 + 톤 바꾸기](/courses/ai-work/09-proofread-tone/) `교정` `맞춤법` `1단계`
...
출처: [내가 쓴 글 교정 + 톤 바꾸기](/courses/ai-work/09-proofread-tone/) `톤` `길이` `2단계`
...
출처: [내가 쓴 글 교정 + 톤 바꾸기](/courses/ai-work/09-proofread-tone/) `다듬기` `문장` `대안`
...
출처: [내가 쓴 글 교정 + 톤 바꾸기](/courses/ai-work/09-proofread-tone/) `검수` `환각` `사실확인`
...
출처: [상대별 이메일 톤 조정](/courses/ai-work/10-recipient-tone/) `톤` `이메일` `3버전`
...
출처: [상대별 이메일 톤 조정](/courses/ai-work/10-recipient-tone/) `톤` `사외` `정중`
...
출처: [상대별 이메일 톤 조정](/courses/ai-work/10-recipient-tone/) `톤` `영문` `검수`
...
출처: [상대별 이메일 톤 조정](/courses/ai-work/10-recipient-tone/) `톤` `수위조절`
...
출처: [긴 문서·회의록·메일 스레드 요약하기](/courses/ai-work/11-long-doc-summary/) `요약` `회의록` `표` `액션항목`
...
출처: [긴 문서·회의록·메일 스레드 요약하기](/courses/ai-work/11-long-doc-summary/) `요약` `메일` `스레드`
...
출처: [긴 문서·회의록·메일 스레드 요약하기](/courses/ai-work/11-long-doc-summary/) `요약` `보고서` `PDF` `수치`
...
출처: [긴 문서·회의록·메일 스레드 요약하기](/courses/ai-work/11-long-doc-summary/) `검증` `대조` `환각`
...
출처: [긴 메일 스레드 요약 답장](/courses/ai-work/12-thread-summary-reply/) `요약` `쟁점표` `스레드`
...
출처: [긴 메일 스레드 요약 답장](/courses/ai-work/12-thread-summary-reply/) `회신` `초안` `다음액션`
...
출처: [긴 메일 스레드 요약 답장](/courses/ai-work/12-thread-summary-reply/) `점검` `미답변` `질문`
...
출처: [긴 메일 스레드 요약 답장](/courses/ai-work/12-thread-summary-reply/) `톤` `다듬기` `번역투`
...
출처: [반복 이메일 템플릿화](/courses/ai-work/13-email-templates/) `이메일` `템플릿` `변수`
...
출처: [반복 이메일 템플릿화](/courses/ai-work/13-email-templates/) `이메일` `거절` `템플릿`
...
출처: [반복 이메일 템플릿화](/courses/ai-work/13-email-templates/) `이메일` `요청` `템플릿`
...
출처: [반복 이메일 템플릿화](/courses/ai-work/13-email-templates/) `이메일` `톤` `통일`
...
출처: [메모·개조식 자료로 보고서 한 편 완성](/courses/ai-work/14-notes-to-report/) `보고서` `5단구조` `임원보고` `예시포함`
...
출처: [메모·개조식 자료로 보고서 한 편 완성](/courses/ai-work/14-notes-to-report/) `보고서` `제안` `실행안`
...
출처: [메모·개조식 자료로 보고서 한 편 완성](/courses/ai-work/14-notes-to-report/) `보고서` `검수` `환각방지`
...
출처: [메모·개조식 자료로 보고서 한 편 완성](/courses/ai-work/14-notes-to-report/) `보고서` `톤` `두괄식`
...
출처: [문서 목차부터 짜기](/courses/ai-work/15-outline-first/) `프롬프트` `목차` `3안`
...
출처: [문서 목차부터 짜기](/courses/ai-work/15-outline-first/) `프롬프트` `소제목` `세분화`
...
출처: [문서 목차부터 짜기](/courses/ai-work/15-outline-first/) `프롬프트` `논리 점검` `구조`
...
출처: [문서 목차부터 짜기](/courses/ai-work/15-outline-first/) `프롬프트` `본문` `섹션`
...
출처: [경영진용 한 장 요약](/courses/ai-work/16-executive-summary/) `요약` `경영진 요약` `BLUF` `압축`
...
출처: [경영진용 한 장 요약](/courses/ai-work/16-executive-summary/) `핵심 추출` `근거` `압축`
...
출처: [경영진용 한 장 요약](/courses/ai-work/16-executive-summary/) `길이 조절` `형식`
...
출처: [경영진용 한 장 요약](/courses/ai-work/16-executive-summary/) `팩트체크` `검증` `숫자`
...
출처: [AI 답변의 출처·인용을 직접 확인하기](/courses/ai-work/17-verify-sources/) `출처검증` `가짜링크` `재요청`
...
출처: [AI 답변의 출처·인용을 직접 확인하기](/courses/ai-work/17-verify-sources/) `출처검증` `1차출처` `추궁`
...
출처: [AI 답변의 출처·인용을 직접 확인하기](/courses/ai-work/17-verify-sources/) `검증메모` `3색` `양식`
...
출처: [AI 초안 사실 검증](/courses/ai-work/18-fact-check-draft/) `사실검증` `환각` `추출`
...
출처: [AI 초안 사실 검증](/courses/ai-work/18-fact-check-draft/) `사실검증` `단정` `색출`
...
출처: [AI 초안 사실 검증](/courses/ai-work/18-fact-check-draft/) `사실검증` `재작성` `출처`
...
출처: [AI 초안 사실 검증](/courses/ai-work/18-fact-check-draft/) `사실검증` `인용` `검색어`
...
출처: [엑셀/CSV 올려서 자연어로 질문하고 답 받기](/courses/ai-work/19-csv-natural-query/) `데이터 분석` `구조 확인` `안전 시작`
...
출처: [엑셀/CSV 올려서 자연어로 질문하고 답 받기](/courses/ai-work/19-csv-natural-query/) `데이터 분석` `집계` `정렬`
...
출처: [엑셀/CSV 올려서 자연어로 질문하고 답 받기](/courses/ai-work/19-csv-natural-query/) `데이터 분석` `top-n` `필터`
...
출처: [엑셀/CSV 올려서 자연어로 질문하고 답 받기](/courses/ai-work/19-csv-natural-query/) `데이터 분석` `검산` `검증`
...
출처: [엑셀/CSV 올려서 자연어로 질문하고 답 받기](/courses/ai-work/19-csv-natural-query/) `데이터 분석` `엑셀` `내보내기`
...
출처: [엑셀/CSV 올려서 자연어로 질문하고 답 받기](/courses/ai-work/19-csv-natural-query/) `데이터 분석` `CSV` `우회`
...
출처: [자연어로 엑셀 수식 만들기](/courses/ai-work/20-natural-language-formula/) `엑셀` `수식생성` `표구조` `VLOOKUP`
...
출처: [자연어로 엑셀 수식 만들기](/courses/ai-work/20-natural-language-formula/) `엑셀` `에러수정` `디버깅`
...
출처: [자연어로 엑셀 수식 만들기](/courses/ai-work/20-natural-language-formula/) `엑셀` `SUMIF` `COUNTIF` `조건계산`
...
출처: [자연어로 엑셀 수식 만들기](/courses/ai-work/20-natural-language-formula/) `엑셀` `자연어` `IF` `절대참조`
...
출처: [지저분한 데이터 정리](/courses/ai-work/21-data-cleaning/) `데이터 클리닝` `진단` `오염 유형`
...
출처: [지저분한 데이터 정리](/courses/ai-work/21-data-cleaning/) `데이터 클리닝` `엑셀 수식` `표준화`
...
출처: [지저분한 데이터 정리](/courses/ai-work/21-data-cleaning/) `데이터 클리닝` `중복 제거` `동명이인`
...
출처: [지저분한 데이터 정리](/courses/ai-work/21-data-cleaning/) `데이터 클리닝` `검산` `품질 점검`
...
출처: [표 붙여넣고 인사이트 캐묻기](/courses/ai-work/22-table-insight-interview/) `데이터 인터뷰` `맥락` `첫 질문`
...
출처: [표 붙여넣고 인사이트 캐묻기](/courses/ai-work/22-table-insight-interview/) `후속 질문` `이상치` `반례`
...
출처: [표 붙여넣고 인사이트 캐묻기](/courses/ai-work/22-table-insight-interview/) `이상치` `패턴` `탐지`
...
출처: [표 붙여넣고 인사이트 캐묻기](/courses/ai-work/22-table-insight-interview/) `요약` `보고` `의사결정`
...
출처: [데이터에서 차트·피벗표 만들어 인사이트 보기](/courses/ai-work/23-charts-pivot-insight/) `피벗표` `데이터 분석` `집계`
...
출처: [데이터에서 차트·피벗표 만들어 인사이트 보기](/courses/ai-work/23-charts-pivot-insight/) `차트` `막대 차트` `시각화`
...
출처: [데이터에서 차트·피벗표 만들어 인사이트 보기](/courses/ai-work/23-charts-pivot-insight/) `이상치` `추세` `인사이트`
...
출처: [데이터에서 차트·피벗표 만들어 인사이트 보기](/courses/ai-work/23-charts-pivot-insight/) `보고서` `피벗표` `차트`
...
출처: [데이터에서 차트·피벗표 만들어 인사이트 보기](/courses/ai-work/23-charts-pivot-insight/) `무료 플랜` `우회` `텍스트 분석`
...
출처: [피벗테이블 설계하기](/courses/ai-work/24-pivot-table-design/) `피벗테이블` `설계` `행·열·값`
...
출처: [피벗테이블 설계하기](/courses/ai-work/24-pivot-table-design/) `계산 필드` `수식` `이익률`
...
출처: [피벗테이블 설계하기](/courses/ai-work/24-pivot-table-design/) `표 해석` `검증` `인사이트`
...
출처: [피벗테이블 설계하기](/courses/ai-work/24-pivot-table-design/) `원자료` `진단` `데이터 정리`
...
출처: [맞는 차트 고르고 다듬기](/courses/ai-work/25-chart-selection/) `차트 선택` `목적` `추천`
...
출처: [맞는 차트 고르고 다듬기](/courses/ai-work/25-chart-selection/) `차트 선택` `제목` `결론`
...
출처: [맞는 차트 고르고 다듬기](/courses/ai-work/25-chart-selection/) `차트 선택` `오해 테스트` `검수`
...
출처: [맞는 차트 고르고 다듬기](/courses/ai-work/25-chart-selection/) `차트 선택` `색 강조` `정리`
...
출처: [한 장 대시보드 만들기](/courses/ai-work/26-one-page-dashboard/) `대시보드` `설계`
...
출처: [한 장 대시보드 만들기](/courses/ai-work/26-one-page-dashboard/) `슬라이서` `보고서 연결`
...
출처: [한 장 대시보드 만들기](/courses/ai-work/26-one-page-dashboard/) `KPI 카드` `수식`
...
출처: [한 장 대시보드 만들기](/courses/ai-work/26-one-page-dashboard/) `레이아웃` `배색`
...
출처: [슬라이드 스토리라인 짜기](/courses/ai-work/27-slide-storyline/) `발표` `스토리라인` `초안` `도입-근거-결론`
...
출처: [슬라이드 스토리라인 짜기](/courses/ai-work/27-slide-storyline/) `발표` `반론` `점검` `근거`
...
출처: [슬라이드 스토리라인 짜기](/courses/ai-work/27-slide-storyline/) `발표` `슬라이드 제목` `한 슬라이드 한 메시지`
...
출처: [슬라이드 스토리라인 짜기](/courses/ai-work/27-slide-storyline/) `발표` `논리 흐름` `점검`
...
출처: [Gamma로 발표 슬라이드 초안 10분 만에 만들기](/courses/ai-work/28-gamma-slides/) `Gamma` `슬라이드 생성` `초안`
...
출처: [Gamma로 발표 슬라이드 초안 10분 만에 만들기](/courses/ai-work/28-gamma-slides/) `Gamma` `수정` `자연어 지시`
...
출처: [Gamma로 발표 슬라이드 초안 10분 만에 만들기](/courses/ai-work/28-gamma-slides/) `Gamma` `차트` `시각화`
...
출처: [Gamma로 발표 슬라이드 초안 10분 만에 만들기](/courses/ai-work/28-gamma-slides/) `Gamma` `발표 대본` `스크립트`
...
출처: [개요를 Gamma 덱으로](/courses/ai-work/29-outline-to-gamma/) `Gamma` `개요` `마크다운`
...
출처: [개요를 Gamma 덱으로](/courses/ai-work/29-outline-to-gamma/) `Gamma` `슬라이드 문구` `압축`
...
출처: [개요를 Gamma 덱으로](/courses/ai-work/29-outline-to-gamma/) `Gamma` `슬라이드 병합` `편집`
...
출처: [개요를 Gamma 덱으로](/courses/ai-work/29-outline-to-gamma/) `Gamma` `제목` `리라이트`
...
출처: [슬라이드 디자인 다듬기](/courses/ai-work/30-slide-design-polish/) `프롬프트` `진단` `슬라이드`
...
출처: [슬라이드 디자인 다듬기](/courses/ai-work/30-slide-design-polish/) `프롬프트` `폰트 위계` `글꼴`
...
출처: [슬라이드 디자인 다듬기](/courses/ai-work/30-slide-design-polish/) `프롬프트` `색 대비` `배색`
...
출처: [슬라이드 디자인 다듬기](/courses/ai-work/30-slide-design-polish/) `프롬프트` `일관성` `스타일 통일`
...
출처: [발표노트와 예상질문 준비](/courses/ai-work/31-speaker-notes-qa/) `발표` `스크립트` `발표노트`
...
출처: [발표노트와 예상질문 준비](/courses/ai-work/31-speaker-notes-qa/) `발표` `예상질문` `반박형`
...
출처: [발표노트와 예상질문 준비](/courses/ai-work/31-speaker-notes-qa/) `발표` `모범답변` `할루시네이션`
...
출처: [발표노트와 예상질문 준비](/courses/ai-work/31-speaker-notes-qa/) `발표` `모의Q&A` `리허설`
...
출처: [Canva AI로 SNS 게시물 세트 디자인하기](/courses/ai-work/32-canva-sns-design/) `Canva` `초안 생성` `SNS`
...
출처: [Canva AI로 SNS 게시물 세트 디자인하기](/courses/ai-work/32-canva-sns-design/) `Canva` `브랜드 키트` `수정`
...
출처: [Canva AI로 SNS 게시물 세트 디자인하기](/courses/ai-work/32-canva-sns-design/) `Canva` `Magic Switch` `리사이즈`
...
출처: [통화·미팅 요약과 후속 액션 자동 추출](/courses/ai-work/33-call-meeting-summary/) `통화요약` `액션아이템` `표` `CRM`
...
출처: [통화·미팅 요약과 후속 액션 자동 추출](/courses/ai-work/33-call-meeting-summary/) `엑셀` `탭구분` `형식`
...
출처: [통화·미팅 요약과 후속 액션 자동 추출](/courses/ai-work/33-call-meeting-summary/) `CRM` `한줄요약`
...
출처: [통화·미팅 요약과 후속 액션 자동 추출](/courses/ai-work/33-call-meeting-summary/) `회의록` `액션아이템` `담당자`
...
출처: [통화·미팅 요약과 후속 액션 자동 추출](/courses/ai-work/33-call-meeting-summary/) `후속통화` `준비멘트`
...
출처: [마케팅 카피·소셜 포스트 A/B 변형 대량 생성](/courses/ai-work/34-marketing-copy-ab/) `카피` `인스타` `톤` `변형`
...
출처: [마케팅 카피·소셜 포스트 A/B 변형 대량 생성](/courses/ai-work/34-marketing-copy-ab/) `표` `비교` `선별`
...
출처: [마케팅 카피·소셜 포스트 A/B 변형 대량 생성](/courses/ai-work/34-marketing-copy-ab/) `광고카피` `이메일제목` `확장`
...
출처: [마케팅 카피·소셜 포스트 A/B 변형 대량 생성](/courses/ai-work/34-marketing-copy-ab/) `A/B테스트` `반복` `브랜드톤`
...
출처: [운영 데이터 분석·KPI 요약 리포트 생성](/courses/ai-work/35-ops-data-kpi-report/) `데이터 분석` `역할부여` `예시`
...
출처: [운영 데이터 분석·KPI 요약 리포트 생성](/courses/ai-work/35-ops-data-kpi-report/) `KPI` `데이터 분석` `템플릿`
...
출처: [운영 데이터 분석·KPI 요약 리포트 생성](/courses/ai-work/35-ops-data-kpi-report/) `검증` `환각` `검산`
...
출처: [운영 데이터 분석·KPI 요약 리포트 생성](/courses/ai-work/35-ops-data-kpi-report/) `리포트` `출력형식` `요약`
...
출처: [운영 데이터 분석·KPI 요약 리포트 생성](/courses/ai-work/35-ops-data-kpi-report/) `차트` `한글깨짐` `트러블슈팅`
...
출처: [출처 신뢰도 평가](/courses/ai-work/36-source-credibility/) `출처평가` `체크리스트` `등급`
...
출처: [출처 신뢰도 평가](/courses/ai-work/36-source-credibility/) `원본추적` `1차출처`
...
출처: [출처 신뢰도 평가](/courses/ai-work/36-source-credibility/) `이해관계` `편향`
...
출처: [출처 신뢰도 평가](/courses/ai-work/36-source-credibility/) `출처비교` `인용`
...
출처: [리서치 질문 좁히기](/courses/ai-work/37-narrow-research-question/) `리서치` `질문쪼개기` `5W`
...
출처: [리서치 질문 좁히기](/courses/ai-work/37-narrow-research-question/) `리서치` `측정가능` `질문다듬기`
...
출처: [리서치 질문 좁히기](/courses/ai-work/37-narrow-research-question/) `리서치` `성공기준` `범위`
...
출처: [리서치 질문 좁히기](/courses/ai-work/37-narrow-research-question/) `리서치` `우선순위` `범위좁히기`
...
출처: [여러 출처 교차·종합](/courses/ai-work/38-cross-reference-synthesis/) `비교표` `교차검증` `출처`
...
출처: [여러 출처 교차·종합](/courses/ai-work/38-cross-reference-synthesis/) `상충` `원인분석` `수치`
...
출처: [여러 출처 교차·종합](/courses/ai-work/38-cross-reference-synthesis/) `종합` `결론` `편향방지`
...
출처: [여러 출처 교차·종합](/courses/ai-work/38-cross-reference-synthesis/) `편향` `자가점검` `검토`
...
출처: [Deep Research로 인용 리포트 자동 생성·검수](/courses/ai-work/39-deep-research-report/) `딥리서치` `의뢰문` `리서치`
...
출처: [Deep Research로 인용 리포트 자동 생성·검수](/courses/ai-work/39-deep-research-report/) `딥리서치` `검증` `출처`
...
출처: [Deep Research로 인용 리포트 자동 생성·검수](/courses/ai-work/39-deep-research-report/) `딥리서치` `비교표` `출처`
...
출처: [Deep Research로 인용 리포트 자동 생성·검수](/courses/ai-work/39-deep-research-report/) `딥리서치` `보강` `출처`
...
출처: [Deep Research로 인용 리포트 자동 생성·검수](/courses/ai-work/39-deep-research-report/) `딥리서치` `예시` `의뢰문`
...
출처: [자동화할 업무 찾기](/courses/ai-work/40-find-automation-tasks/) `자동화` `우선순위` `업무로그`
...
출처: [자동화할 업무 찾기](/courses/ai-work/40-find-automation-tasks/) `자동화` `진단` `후보`
...
출처: [자동화할 업무 찾기](/courses/ai-work/40-find-automation-tasks/) `자동화` `실행` `첫단계`
...
출처: [자동화할 업무 찾기](/courses/ai-work/40-find-automation-tasks/) `자동화` `사분면` `우선순위`
...
출처: [내 업무용 커스텀 GPT/Claude Project 직접 만들기 (노코드)](/courses/ai-work/41-custom-gpt-nocode/) `프롬프트` `시스템 프롬프트` `RODES`
...
출처: [내 업무용 커스텀 GPT/Claude Project 직접 만들기 (노코드)](/courses/ai-work/41-custom-gpt-nocode/) `프롬프트` `검증` `테스트`
...
출처: [Custom GPT 지시문 설계](/courses/ai-work/42-custom-gpt-instructions/) `지시문` `초안` `4블록`
...
출처: [Custom GPT 지시문 설계](/courses/ai-work/42-custom-gpt-instructions/) `금지사항` `가드레일` `환각`
...
출처: [Custom GPT 지시문 설계](/courses/ai-work/42-custom-gpt-instructions/) `테스트` `엣지케이스` `약점`
...
출처: [Custom GPT 지시문 설계](/courses/ai-work/42-custom-gpt-instructions/) `출력형식` `템플릿`
...
출처: [트리거→AI→액션 자동화 파이프라인 설계 (Zapier/Make)](/courses/ai-work/43-trigger-ai-action-pipeline/) `분류` `이메일` `JSON 출력` `안전 기본값`
...
출처: [트리거→AI→액션 자동화 파이프라인 설계 (Zapier/Make)](/courses/ai-work/43-trigger-ai-action-pipeline/) `승인 게이트` `Slack` `검토`
...
출처: [트리거→AI→액션 자동화 파이프라인 설계 (Zapier/Make)](/courses/ai-work/43-trigger-ai-action-pipeline/) `가드레일` `PII` `안전`
...
출처: [첫 노코드 파이프라인](/courses/ai-work/44-first-nocode-pipeline/) `프롬프트` `트리거` `액션` `자동화`
...
출처: [첫 노코드 파이프라인](/courses/ai-work/44-first-nocode-pipeline/) `프롬프트` `아이디어` `자동화`
...
출처: [첫 노코드 파이프라인](/courses/ai-work/44-first-nocode-pipeline/) `프롬프트` `디버깅` `Zapier`
...
출처: [첫 노코드 파이프라인](/courses/ai-work/44-first-nocode-pipeline/) `프롬프트` `필드 매핑` `Zapier`
...
출처: [다단계·조건분기 자동화](/courses/ai-work/45-multistep-branching/) `자동화` `설계` `순서도`
...
출처: [다단계·조건분기 자동화](/courses/ai-work/45-multistep-branching/) `분기` `필터` `조건`
...
출처: [다단계·조건분기 자동화](/courses/ai-work/45-multistep-branching/) `오류 처리` `재시도`
...
출처: [다단계·조건분기 자동화](/courses/ai-work/45-multistep-branching/) `점검` `검증`
...
출처: [자동화에 AI 단계 넣기](/courses/ai-work/46-ai-step-in-automation/) `프롬프트` `분류` `출력형식`
...
출처: [자동화에 AI 단계 넣기](/courses/ai-work/46-ai-step-in-automation/) `프롬프트` `요약` `출력형식`
...
출처: [자동화에 AI 단계 넣기](/courses/ai-work/46-ai-step-in-automation/) `프롬프트` `초안`
...
출처: [자동화에 AI 단계 넣기](/courses/ai-work/46-ai-step-in-automation/) `프롬프트` `개선` `테스트`
...
출처: [자동화 테스트·유지보수](/courses/ai-work/47-automation-testing/) `자동화` `알림` `오류처리`
...
출처: [자동화 테스트·유지보수](/courses/ai-work/47-automation-testing/) `자동화` `테스트` `테스트데이터`
...
출처: [자동화 테스트·유지보수](/courses/ai-work/47-automation-testing/) `자동화` `로그` `유지보수`
...
출처: [자동화 테스트·유지보수](/courses/ai-work/47-automation-testing/) `자동화` `점검` `로그`
...
출처: [주간보고 자동화 캡스톤](/courses/ai-work/48-weekly-report-capstone/) `요약` `데이터` `안전장치`
...
출처: [주간보고 자동화 캡스톤](/courses/ai-work/48-weekly-report-capstone/) `슬라이드` `출력형식`
...
출처: [주간보고 자동화 캡스톤](/courses/ai-work/48-weekly-report-capstone/) `이메일` `보고` `출력형식`
