...
- [경영진용 한 장 요약](/en/courses/ai-work/16-executive-summary/) <sub>(AI for Work)</sub>
- [엑셀/CSV 올려서 자연어로 질문하고 답 받기](/en/courses/ai-work/19-csv-natural-query/) <sub>(AI for Work)</sub>
- [자연어로 엑셀 수식 만들기](/en/courses/ai-work/20-natural-language-formula/) <sub>(AI for Work)</sub>
- [표 붙여넣고 인사이트 캐묻기](/en/courses/ai-work/22-table-insight-interview/) <sub>(AI for Work)</sub>
- [Deep Research로 인용 리포트 자동 생성·검수](/en/courses/ai-work/39-deep-research-report/) <sub>(AI for Work)</sub>
