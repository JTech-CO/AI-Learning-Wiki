...
<span id="reference-2"></span>2. [Reinforcement learning from human feedback — Wikipedia](https://en.wikipedia.org/wiki/Reinforcement_learning_from_human_feedback) — encyclopedia
...
<span id="reference-6"></span>6. [Machine learning — Wikipedia](https://en.wikipedia.org/wiki/Machine_learning) — encyclopedia
