...
[프롬프트 시스템 설계](/course/prompt-systems/) · [AI 기초](/course/ai-foundations/)
...
2. <span id="reference-2"></span>[Prompt - Wikipedia](https://en.wikipedia.org/wiki/Prompt) - encyclopedia
