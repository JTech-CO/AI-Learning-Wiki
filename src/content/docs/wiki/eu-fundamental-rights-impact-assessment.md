---
title: "EU 기본권 영향평가 EU Fundamental Rights Impact Assessment"
description: "EU 기본권 영향평가(FRIA)는 특정 고위험 AI 배포자가 사용 맥락에서 기본권 영향을 식별·완화하고 감독기관에 알리는 절차다."
tableOfContents: { minHeadingLevel: 2, maxHeadingLevel: 4 }
---

<p class="wiki-alias">FRIA · Fundamental Rights Impact Assessment</p>

<p class="wiki-lead">EU 기본권 영향평가(FRIA)는 특정 고위험 AI 배포자가 사용 맥락에서 기본권 영향을 식별·완화하고 감독기관에 알리는 절차다.</p>
...
- [알고리즘 영향 평가](/wiki/algorithmic-impact-assessment/): 법적 범위와 통제를 이해하기 위한 선수 개념이다.

#### 함께 비교할 문서

- [한국 AI 영향평가](/wiki/korean-ai-impact-assessment/): 관할·역할·수명주기 단계가 다른 인접 개념이다.
- [개인정보 보호](/wiki/privacy/): 관할·역할·수명주기 단계가 다른 인접 개념이다.
- [알고리즘 이의제기 가능성](/wiki/algorithmic-contestability/): 관할·역할·수명주기 단계가 다른 인접 개념이다.
...
- **AI 규제와 리터러시:** [다음 문서 — 알고리즘 이의제기 가능성](/wiki/algorithmic-contestability/)
