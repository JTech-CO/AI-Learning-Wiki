...
4. <span id="reference-4"></span>[전치 행렬 - 한국어 위키백과](https://ko.wikipedia.org/wiki/%EC%A0%84%EC%B9%98_%ED%96%89%EB%A0%AC) - encyclopedia

### 코스에서 계속 읽기

- **AI를 위한 수학·통계:** [다음 문서 — 선형 변환](/wiki/linear-transformation/)
