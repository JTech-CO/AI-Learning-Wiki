---
title: "한국 AI 안전성 확보 의무 Korean AI Safety Duty"
description: "한국 AI 안전성 확보 의무는 법정 누적 연산량 기준 이상 인공지능시스템의 수명주기 위험관리와 안전사고 대응을 요구하는 제도다."
tableOfContents: { minHeadingLevel: 2, maxHeadingLevel: 4 }
---

<p class="wiki-alias">인공지능 안전성 확보 의무</p>

<p class="wiki-lead">한국 AI 안전성 확보 의무는 법정 누적 연산량 기준 이상 인공지능시스템의 수명주기 위험관리와 안전사고 대응을 요구하는 제도다.</p>
...
- [AI 위험 평가](/wiki/ai-risk-assessment/): 법적 범위와 통제를 이해하기 위한 선수 개념이다.

#### 함께 비교할 문서

- [AI 사고 보고](/wiki/ai-incident-reporting/): 관할·역할·수명주기 단계가 다른 인접 개념이다.
- [AI 위험 대장](/wiki/ai-risk-register/): 관할·역할·수명주기 단계가 다른 인접 개념이다.
...
- **AI 규제와 리터러시:** [다음 문서 — AI 위험 평가](/wiki/ai-risk-assessment/)
