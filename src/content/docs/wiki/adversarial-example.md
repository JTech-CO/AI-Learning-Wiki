---
title: "적대적 예시 Adversarial Example"
description: "사람이 보기에는 같거나 의미가 유지되지만 모델의 예측을 바꾸도록 의도적으로 조작된 입력이다."
tableOfContents: { minHeadingLevel: 2, maxHeadingLevel: 4 }
---

<p class="wiki-lead">사람이 보기에는 같거나 의미가 유지되지만 모델의 예측을 바꾸도록 의도적으로 조작된 입력이다.</p>
...
- **AI 보안과 레드팀:** [다음 문서 — 프롬프트 인젝션](/wiki/prompt-injection/)
