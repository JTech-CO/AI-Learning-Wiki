...
<div class="wiki-document-meta">분류: [모델·서비스 생태계](/category/ecosystem/) · 문서 상태: 검토 완료 · 최근 검토: 2026-07-12</div>
...
모델 라이선스는 가중치와 코드, 데이터, 출력의 사용·배포·상업 이용·파생 모델 조건을 각각 규정할 수 있다.
