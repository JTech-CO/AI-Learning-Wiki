---
title: "EU 고위험 AI 적합성 평가 EU High-Risk AI Conformity Assessment"
description: "EU 고위험 AI 적합성 평가는 시장 출시·사용 개시 전에 시스템이 AI Act 필수 요구사항을 충족함을 입증하는 절차다."
tableOfContents: { minHeadingLevel: 2, maxHeadingLevel: 4 }
---

<p class="wiki-alias">AI Act Conformity Assessment</p>

<p class="wiki-lead">EU 고위험 AI 적합성 평가는 시장 출시·사용 개시 전에 시스템이 AI Act 필수 요구사항을 충족함을 입증하는 절차다.</p>
...
평가는 위험관리, 데이터 거버넌스, 기술 문서, 기록, 투명성, 인간 감독, 정확성·견고성·사이버보안과 품질관리 체계를 대상으로 한다. 중대한 변경이나 의도된 목적 변경은 평가 반복을 유발할 수 있다.
...
적용 요구사항과 표준을 통제·시험·증거에 매핑하고 부족 사항을 조치한다. 해당 평가 경로를 선택해 기술 문서와 선언을 준비하고 필요한 경우 인증기관 심사를 거친 뒤 등록·표시·출시 승인을 수행한다.
...
요구사항 추적표, 위험관리 파일, 데이터·시험 보고서, 인간 감독 설계, 품질관리 기록, 인증기관 교신, EU 적합성 선언과 변경평가를 보존한다. 사용한 조화표준의 버전과 적용 범위도 남긴다.
...
출시된 바이너리·모델·데이터·설정이 평가 대상 버전과 같은지 해시와 구성으로 대조한다. 변경 요청마다 중대성을 판정하고 재평가·문서 갱신·시장 조치 여부를 기록한다.
...
- [안전성 논증서](/wiki/safety-case/): 관할·역할·수명주기 단계가 다른 인접 개념이다.
- [모델 아티팩트 서명](/wiki/model-artifact-signing/): 관할·역할·수명주기 단계가 다른 인접 개념이다.
...
- EU 고위험 AI 적합성 평가의 관할, 적용 시점, 대상 주체와 대상 시스템을 구분해 설명할 수 있는가?
...
- **AI 규제와 리터러시:** [다음 문서 — 안전성 논증서](/wiki/safety-case/)
